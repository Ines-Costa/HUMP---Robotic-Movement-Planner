...
HandPosPlot::HandPosPlot(vector<vector<double>>& hand_pos)
{
    ...
    double x_min = hand_func.getX_min(); 
    double x_max = hand_func.getX_max();
    double y_min = hand_func.getY_min(); 
    double y_max = hand_func.getY_max();
    double z_min = hand_func.getZ_min()-5; 
    double z_max = hand_func.getZ_max()+5;
