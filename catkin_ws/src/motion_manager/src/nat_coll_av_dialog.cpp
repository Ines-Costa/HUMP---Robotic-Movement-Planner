...
void NatCollAvDialog::setupPlots(vector<vector<double>> &hand_linear_velocity,vector<vector<double> > &hand_position, vector<vector<vector<double> > > &timesteps)
{
    ...
    // first derivatives
    QVector<double> der_pos_x_1; 
    QVector<double> der_pos_y_1; 
    QVector<double> der_pos_z_1;
    ...
    // second derivatives
    QVector<double> der_pos_x_2; 
    QVector<double> der_pos_y_2; 
    QVector<double> der_pos_z_2;
    ...
    //third derivatives
    QVector<double> der_pos_x_3; 
    QVector<double> der_pos_y_3; 
    QVector<double> der_pos_z_3;
