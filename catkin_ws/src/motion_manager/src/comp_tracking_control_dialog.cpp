...
void CompTrackingControlDialog::on_pushButton_plot_hand_pos_clicked()
{
    ...
    // **** CLEAR **** //
    hand_pos_x.clear(); 
    des_hand_pos_x.clear();
    hand_pos_y.clear(); 
    des_hand_pos_y.clear();
    hand_pos_z.clear(); 
    des_hand_pos_z.clear();
    hand_or_qx.clear(); 
    des_hand_or_qx.clear();
    hand_or_qy.clear(); 
    des_hand_or_qy.clear();
    hand_or_qz.clear(); 
    des_hand_or_qz.clear();
    hand_or_qw.clear(); 
    des_hand_or_qw.clear();
...
void CompTrackingControlDialog::on_pushButton_plot_hand_vel_clicked()
{
    ...
    // **** CLEAR **** //
    hand_lin_vel_x.clear(); 
    des_hand_lin_vel_x.clear();
    hand_lin_vel_y.clear(); 
    des_hand_lin_vel_y.clear();
    hand_lin_vel_z.clear(); 
    des_hand_lin_vel_z.clear();
    hand_ang_vel_x.clear(); 
    des_hand_ang_vel_x.clear();
    hand_ang_vel_y.clear(); 
    des_hand_ang_vel_y.clear();
    hand_ang_vel_z.clear(); 
    des_hand_ang_vel_z.clear();
...
void CompTrackingControlDialog::on_pushButton_plot_hand_acc_clicked()
{
    ...
    // **** CLEAR **** //
    hand_lin_acc_x.clear();
    des_hand_lin_acc_x.clear();
    hand_lin_acc_y.clear(); 
    des_hand_lin_acc_y.clear();
    hand_lin_acc_z.clear();
    des_hand_lin_acc_z.clear();
    hand_ang_acc_x.clear();
    des_hand_ang_acc_x.clear();
    hand_ang_acc_y.clear(); 
    des_hand_ang_acc_y.clear();
    hand_ang_acc_z.clear(); 
    des_hand_ang_acc_z.clear();
...
void CompTrackingControlDialog::on_pushButton_plot_fing_pos_clicked()
{
    ...
    // **** CLEAR **** //
    pos_fing_0.clear(); 
    des_pos_fing_0.clear();
    pos_fing_1.clear(); 
    des_pos_fing_1.clear();
    pos_fing_2.clear(); 
    des_pos_fing_2.clear();
    pos_fing_3.clear(); 
    des_pos_fing_3.clear();
...
void CompTrackingControlDialog::on_pushButton_plot_fing_vel_clicked()
{
    ...
    // **** CLEAR **** //
    vel_fing_0.clear(); 
    des_vel_fing_0.clear();
    vel_fing_1.clear(); 
    des_vel_fing_1.clear();
    vel_fing_2.clear(); 
    des_vel_fing_2.clear();
    vel_fing_3.clear(); 
    des_vel_fing_3.clear();
...
void CompTrackingControlDialog::on_pushButton_plot_fing_acc_clicked()
{
    ...
    // **** CLEAR **** //
    acc_fing_0.clear(); 
    des_acc_fing_0.clear();
    acc_fing_1.clear(); 
    des_acc_fing_1.clear();
    acc_fing_2.clear(); 
    des_acc_fing_2.clear();
    acc_fing_3.clear(); 
    des_acc_fing_3.clear();
