    ...
    ui(new Ui::TolDialogHUMP)
{
    ui->setupUi(this);
     ...
     QObject::connect(ui->checkBox_EG, SIGNAL(stateChanged(int)), this, SLOT(checkEGHand(int)));
     QObject::connect(ui->checkBox_QbSoftHand, SIGNAL(stateChanged(int)), this, SLOT(checkQbHand(int)));
...
void TolDialogHUMP::adaptationElectricGripper()
{
    ...
    ui->tab_v_a_EG->setEnabled(true);
    ui->tab_v_a_QbSoftHand->setEnabled(false);

    ui->tab_EG_fingers->setEnabled(true);
    ui->tab_QbSoftHand_fingers->setEnabled(false);
    //Points of the hand
    ui->lineEdit_hand_EG_1_3->setText(QString::number(0));
    ui->lineEdit_hand_EG_1_3->setEnabled(false);
    ui->lineEdit_hand_EG_2_1->setText(QString::number(0));
    ui->lineEdit_hand_EG_2_1->setEnabled(false);
    ui->lineEdit_hand_EG_2_2->setText(QString::number(0));
    ui->lineEdit_hand_EG_2_2->setEnabled(false);
    ui->lineEdit_hand_EG_2_3->setText(QString::number(0));
    ui->lineEdit_hand_EG_2_3->setEnabled(false);
    ui->lineEdit_hand_EG_3_1->setText(QString::number(0));
    ui->lineEdit_hand_EG_3_1->setEnabled(false);
    ui->lineEdit_hand_EG_3_2->setText(QString::number(0));
    ui->lineEdit_hand_EG_3_2->setEnabled(false);
    ui->lineEdit_hand_EG_3_3->setText(QString::number(0));
    ui->lineEdit_hand_EG_3_3->setEnabled(false);
    ui->lineEdit_hand_EG_tip_3->setText(QString::number(0));
    ui->lineEdit_hand_EG_tip_3->setEnabled(false);
...
void TolDialogHUMP::adaptationQbSoftHand(){
    ui->tab_v_a_EG->setEnabled(false);
    ui->tab_v_a_QbSoftHand->setEnabled(true);

    ui->tab_EG_fingers->setEnabled(false);
    ui->tab_QbSoftHand_fingers->setEnabled(true);

    //Points of the hand
    ui->lineEdit_hand_Qb_1_1->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_1->setEnabled(true);
    ui->lineEdit_hand_Qb_2_1->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_1->setEnabled(true);
    ui->lineEdit_hand_Qb_3_1->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_1->setEnabled(true);
    ui->lineEdit_hand_Qb_4_1->setText(QString::number(0));
    ui->lineEdit_hand_Qb_4_1->setEnabled(false);

    ui->lineEdit_hand_Qb_1_2->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_2->setEnabled(true);
    ui->lineEdit_hand_Qb_2_2->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_2->setEnabled(true);
    ui->lineEdit_hand_Qb_3_2->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_2->setEnabled(true);
    ui->lineEdit_hand_Qb_4_2->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_4_2->setEnabled(true);

    ui->lineEdit_hand_Qb_1_3->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_3->setEnabled(true);
    ui->lineEdit_hand_Qb_2_3->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_3->setEnabled(true);
    ui->lineEdit_hand_Qb_3_3->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_3->setEnabled(true);
    ui->lineEdit_hand_Qb_4_3->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_4_3->setEnabled(true);

    ui->lineEdit_hand_Qb_1_4->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_4->setEnabled(true);
    ui->lineEdit_hand_Qb_2_4->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_4->setEnabled(true);
    ui->lineEdit_hand_Qb_3_4->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_4->setEnabled(true);
    ui->lineEdit_hand_Qb_4_4->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_4_4->setEnabled(true);

    ui->lineEdit_hand_Qb_1_5->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_5->setEnabled(true);
    ui->lineEdit_hand_Qb_2_5->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_5->setEnabled(true);
    ui->lineEdit_hand_Qb_3_5->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_5->setEnabled(true);
    ui->lineEdit_hand_Qb_4_5->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_4_5->setEnabled(true);

    ui->lineEdit_hand_Qb_tip_1->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_1->setEnabled(true);
    ui->lineEdit_hand_Qb_tip_2->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_2->setEnabled(true);
    ui->lineEdit_hand_Qb_tip_3->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_3->setEnabled(true);
    ui->lineEdit_hand_Qb_tip_4->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_4->setEnabled(true);
    ui->lineEdit_hand_Qb_tip_5->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_5->setEnabled(true);

    // Joint Expense Factors
    ui->lineEdit_lambda_1->setText(QString::number(1.0));
    ui->lineEdit_lambda_1->setEnabled(true);
    ui->lineEdit_lambda_2->setText(QString::number(1.0));
    ui->lineEdit_lambda_2->setEnabled(true);
    ui->lineEdit_lambda_3->setText(QString::number(1.0));
    ui->lineEdit_lambda_3->setEnabled(true);
    ui->lineEdit_lambda_4->setText(QString::number(1.0));
    ui->lineEdit_lambda_4->setEnabled(true);
    ui->lineEdit_lambda_5->setText(QString::number(1.0));
    ui->lineEdit_lambda_5->setEnabled(true);
    ui->lineEdit_lambda_6->setText(QString::number(1.0));
    ui->lineEdit_lambda_6->setEnabled(true);
    ui->lineEdit_lambda_7->setText(QString::number(1.0));
    ui->lineEdit_lambda_7->setEnabled(true);
    ui->lineEdit_lambda_8->setText(QString::number(1.0));
    ui->lineEdit_lambda_8->setEnabled(true);
    ui->lineEdit_lambda_9->setText(QString::number(1.0));
    ui->lineEdit_lambda_9->setEnabled(true);
    ui->lineEdit_lambda_10->setText(QString::number(0.0));
    ui->lineEdit_lambda_10->setEnabled(false);
    ui->lineEdit_lambda_11->setText(QString::number(0.0));
    ui->lineEdit_lambda_11->setEnabled(false);

    //Boundary conditions
    //init vel
    ui->lineEdit_init_vel_1->setText(QString::number(0));
    ui->lineEdit_init_vel_1->setEnabled(true);
    ui->lineEdit_init_vel_2->setText(QString::number(0));
    ui->lineEdit_init_vel_2->setEnabled(true);
    ui->lineEdit_init_vel_3->setText(QString::number(0));
    ui->lineEdit_init_vel_3->setEnabled(true);
    ui->lineEdit_init_vel_4->setText(QString::number(0));
    ui->lineEdit_init_vel_4->setEnabled(true);
    ui->lineEdit_init_vel_5->setText(QString::number(0));
    ui->lineEdit_init_vel_5->setEnabled(true);
    ui->lineEdit_init_vel_6->setText(QString::number(0));
    ui->lineEdit_init_vel_6->setEnabled(true);
    ui->lineEdit_init_vel_7->setText(QString::number(0));
    ui->lineEdit_init_vel_7->setEnabled(true);
    ui->lineEdit_init_vel_8->setText(QString::number(0));
    ui->lineEdit_init_vel_8->setEnabled(true);
    ui->lineEdit_init_vel_9->setText(QString::number(0));
    ui->lineEdit_init_vel_9->setEnabled(true);
    ui->lineEdit_init_vel_10->setText(QString::number(0));
    ui->lineEdit_init_vel_10->setEnabled(false);
    ui->lineEdit_init_vel_11->setText(QString::number(0));
    ui->lineEdit_init_vel_11->setEnabled(false);
    //final vel
    ui->lineEdit_final_vel_1->setText(QString::number(0));
    ui->lineEdit_final_vel_1->setEnabled(true);
    ui->lineEdit_final_vel_2->setText(QString::number(0));
    ui->lineEdit_final_vel_2->setEnabled(true);
    ui->lineEdit_final_vel_3->setText(QString::number(0));
    ui->lineEdit_final_vel_3->setEnabled(true);
    ui->lineEdit_final_vel_4->setText(QString::number(0));
    ui->lineEdit_final_vel_4->setEnabled(true);
    ui->lineEdit_final_vel_5->setText(QString::number(0));
    ui->lineEdit_final_vel_5->setEnabled(true);
    ui->lineEdit_final_vel_6->setText(QString::number(0));
    ui->lineEdit_final_vel_6->setEnabled(true);
    ui->lineEdit_final_vel_7->setText(QString::number(0));
    ui->lineEdit_final_vel_7->setEnabled(true);
    ui->lineEdit_final_vel_8->setText(QString::number(0));
    ui->lineEdit_final_vel_8->setEnabled(true);
    ui->lineEdit_final_vel_9->setText(QString::number(0));
    ui->lineEdit_final_vel_9->setEnabled(true);
    ui->lineEdit_final_vel_10->setText(QString::number(0));
    ui->lineEdit_final_vel_10->setEnabled(false);
    ui->lineEdit_final_vel_11->setText(QString::number(0));
    ui->lineEdit_final_vel_11->setEnabled(false);
    //init acc
    ui->lineEdit_init_acc_1->setText(QString::number(0));
    ui->lineEdit_init_acc_1->setEnabled(true);
    ui->lineEdit_init_acc_2->setText(QString::number(0));
    ui->lineEdit_init_acc_2->setEnabled(true);
    ui->lineEdit_init_acc_3->setText(QString::number(0));
    ui->lineEdit_init_acc_3->setEnabled(true);
    ui->lineEdit_init_acc_4->setText(QString::number(0));
    ui->lineEdit_init_acc_4->setEnabled(true);
    ui->lineEdit_init_acc_5->setText(QString::number(0));
    ui->lineEdit_init_acc_5->setEnabled(true);
    ui->lineEdit_init_acc_6->setText(QString::number(0));
    ui->lineEdit_init_acc_6->setEnabled(true);
    ui->lineEdit_init_acc_7->setText(QString::number(0));
    ui->lineEdit_init_acc_7->setEnabled(true);
    ui->lineEdit_init_acc_8->setText(QString::number(0));
    ui->lineEdit_init_acc_8->setEnabled(true);
    ui->lineEdit_init_acc_9->setText(QString::number(0));
    ui->lineEdit_init_acc_9->setEnabled(true);
    ui->lineEdit_init_acc_10->setText(QString::number(0));
    ui->lineEdit_init_acc_10->setEnabled(false);
    ui->lineEdit_init_acc_11->setText(QString::number(0));
    ui->lineEdit_init_acc_11->setEnabled(false);
    //final acc
    ui->lineEdit_final_acc_1->setText(QString::number(0));
    ui->lineEdit_final_acc_1->setEnabled(true);
    ui->lineEdit_final_acc_2->setText(QString::number(0));
    ui->lineEdit_final_acc_2->setEnabled(true);
    ui->lineEdit_final_acc_3->setText(QString::number(0));
    ui->lineEdit_final_acc_3->setEnabled(true);
    ui->lineEdit_final_acc_4->setText(QString::number(0));
    ui->lineEdit_final_acc_4->setEnabled(true);
    ui->lineEdit_final_acc_5->setText(QString::number(0));
    ui->lineEdit_final_acc_5->setEnabled(true);
    ui->lineEdit_final_acc_6->setText(QString::number(0));
    ui->lineEdit_final_acc_6->setEnabled(true);
    ui->lineEdit_final_acc_7->setText(QString::number(0));
    ui->lineEdit_final_acc_7->setEnabled(true);
    ui->lineEdit_final_acc_8->setText(QString::number(0));
    ui->lineEdit_final_acc_8->setEnabled(true);
    ui->lineEdit_final_acc_9->setText(QString::number(0));
    ui->lineEdit_final_acc_9->setEnabled(true);
    ui->lineEdit_final_acc_10->setText(QString::number(0));
    ui->lineEdit_final_acc_10->setEnabled(false);
    ui->lineEdit_final_acc_11->setText(QString::number(0));
    ui->lineEdit_final_acc_11->setEnabled(false);
    ...
    //Final Hand Posture
    ui->lineEdit_final_hand_1->setText(QString::number(0));
    ui->lineEdit_final_hand_1->setEnabled(true);
    ui->lineEdit_final_hand_2->setText(QString::number(0));
    ui->lineEdit_final_hand_2->setEnabled(true);
    ui->lineEdit_final_hand_3->setText(QString::number(0));
    ui->lineEdit_final_hand_3->setEnabled(false);
    ui->lineEdit_final_hand_4->setText(QString::number(0));
    ui->lineEdit_final_hand_4->setEnabled(false);
...
void TolDialogHUMP::getTolsHand(MatrixXd &tols)
{
   ...
   #else
    \
    if(ui->checkBox_EG->isChecked()){
        tols = MatrixXd::Constant(4,3,1);

        tols(0,0) = ui->lineEdit_hand_EG_1_1->text().toDouble();
        tols(0,1) = ui->lineEdit_hand_EG_1_2->text().toDouble();
        tols(0,2) = ui->lineEdit_hand_EG_1_3->text().toDouble();
        tols(1,0) = ui->lineEdit_hand_EG_2_1->text().toDouble();
        tols(1,1) = ui->lineEdit_hand_EG_2_2->text().toDouble();
        tols(1,2) = ui->lineEdit_hand_EG_2_3->text().toDouble();
        tols(2,0) = ui->lineEdit_hand_EG_3_1->text().toDouble();
        tols(2,1) = ui->lineEdit_hand_EG_3_2->text().toDouble();
        tols(2,2) = ui->lineEdit_hand_EG_3_3->text().toDouble();
        tols(3,0) = ui->lineEdit_hand_EG_tip_1->text().toDouble();
        tols(3,1) = ui->lineEdit_hand_EG_tip_2->text().toDouble();
        tols(3,2) = ui->lineEdit_hand_EG_tip_3->text().toDouble();
    }else if(ui->checkBox_QbSoftHand->isChecked()){
      tols = MatrixXd::Constant(5,5,1);

      // Thumb
      tols(0,0) = ui->lineEdit_hand_Qb_1_1->text().toDouble();
      tols(0,1) = ui->lineEdit_hand_Qb_2_1->text().toDouble();
      tols(0,2) = ui->lineEdit_hand_Qb_3_1->text().toDouble();
      tols(0,3) = ui->lineEdit_hand_Qb_4_1->text().toDouble();
      tols(0,4) = ui->lineEdit_hand_Qb_tip_1->text().toDouble();

      // Index
      tols(1,0) = ui->lineEdit_hand_Qb_1_2->text().toDouble();
      tols(1,1) = ui->lineEdit_hand_Qb_2_2->text().toDouble();
      tols(1,2) = ui->lineEdit_hand_Qb_3_2->text().toDouble();
      tols(1,3) = ui->lineEdit_hand_Qb_4_2->text().toDouble();
      tols(1,4) = ui->lineEdit_hand_Qb_tip_2->text().toDouble();

      // Middle
      tols(2,0) = ui->lineEdit_hand_Qb_1_3->text().toDouble();
      tols(2,1) = ui->lineEdit_hand_Qb_2_3->text().toDouble();
      tols(2,2) = ui->lineEdit_hand_Qb_3_3->text().toDouble();
      tols(2,3) = ui->lineEdit_hand_Qb_4_3->text().toDouble();
      tols(2,4) = ui->lineEdit_hand_Qb_tip_3->text().toDouble();

      // Ring
      tols(3,0) = ui->lineEdit_hand_Qb_1_4->text().toDouble();
      tols(3,1) = ui->lineEdit_hand_Qb_2_4->text().toDouble();
      tols(3,2) = ui->lineEdit_hand_Qb_3_4->text().toDouble();
      tols(3,3) = ui->lineEdit_hand_Qb_4_4->text().toDouble();
      tols(3,4) = ui->lineEdit_hand_Qb_tip_4->text().toDouble();

      // Little
      tols(4,0) = ui->lineEdit_hand_Qb_1_5->text().toDouble();
      tols(4,1) = ui->lineEdit_hand_Qb_2_5->text().toDouble();
      tols(4,2) = ui->lineEdit_hand_Qb_3_5->text().toDouble();
      tols(4,3) = ui->lineEdit_hand_Qb_4_5->text().toDouble();
      tols(4,4) = ui->lineEdit_hand_Qb_tip_5->text().toDouble();
    }
    #endif
}
...
void TolDialogHUMP::getLambda(std::vector<double> &lambda)
{
   ...
   #else
    if(ui->checkBox_QbSoftHand->isChecked())
        lambda.push_back(ui->lineEdit_lambda_9->text().toDouble());
   #endif
...
void TolDialogHUMP::getTolsObstacles(MatrixXd &tols)
{
    ...
    tols(0,0)=ui->lineEdit_obs_xx_1->text().toDouble(); 
    tols(0,1)=ui->lineEdit_obs_yy_1->text().toDouble(); 
    tols(0,2)=ui->lineEdit_obs_zz_1->text().toDouble(); 
    tols(0,3)=ui->lineEdit_obs_xy_1->text().toDouble(); 
    tols(0,4)=ui->lineEdit_obs_xz_1->text().toDouble(); 
    tols(0,5)=ui->lineEdit_obs_yz_1->text().toDouble();
    tols(1,0)=ui->lineEdit_obs_xx_2->text().toDouble(); 
    tols(1,1)=ui->lineEdit_obs_yy_2->text().toDouble(); 
    tols(1,2)=ui->lineEdit_obs_zz_2->text().toDouble(); 
    tols(1,3)=ui->lineEdit_obs_xy_2->text().toDouble(); 
    tols(1,4)=ui->lineEdit_obs_xz_2->text().toDouble(); 
    tols(1,5)=ui->lineEdit_obs_yz_2->text().toDouble();
    tols(2,0)=ui->lineEdit_obs_xx_3->text().toDouble(); 
    tols(2,1)=ui->lineEdit_obs_yy_3->text().toDouble(); 
    tols(2,2)=ui->lineEdit_obs_zz_3->text().toDouble(); 
    tols(2,3)=ui->lineEdit_obs_xy_3->text().toDouble(); 
    tols(2,4)=ui->lineEdit_obs_xz_3->text().toDouble(); 
    tols(2,5)=ui->lineEdit_obs_yz_3->text().toDouble();
...
void TolDialogHUMP::getTolsTarget(MatrixXd &tols)
{
    ...
    tols(0,0)=ui->lineEdit_tar_xx_1->text().toDouble(); 
    tols(0,1)=ui->lineEdit_tar_yy_1->text().toDouble(); 
    tols(0,2)=ui->lineEdit_tar_zz_1->text().toDouble(); 
    tols(0,3)=ui->lineEdit_tar_xy_1->text().toDouble(); 
    tols(0,4)=ui->lineEdit_tar_xz_1->text().toDouble(); 
    tols(0,5)=ui->lineEdit_tar_yz_1->text().toDouble();
    tols(1,0)=ui->lineEdit_tar_xx_2->text().toDouble(); 
    tols(1,1)=ui->lineEdit_tar_yy_2->text().toDouble(); 
    tols(1,2)=ui->lineEdit_tar_zz_2->text().toDouble(); 
    tols(1,3)=ui->lineEdit_tar_xy_2->text().toDouble(); 
    tols(1,4)=ui->lineEdit_tar_xz_2->text().toDouble(); 
    tols(1,5)=ui->lineEdit_tar_yz_2->text().toDouble();
    tols(2,0)=ui->lineEdit_tar_xx_3->text().toDouble(); 
    tols(2,1)=ui->lineEdit_tar_yy_3->text().toDouble(); 
    tols(2,2)=ui->lineEdit_tar_zz_3->text().toDouble(); 
    tols(2,3)=ui->lineEdit_tar_xy_3->text().toDouble(); 
    tols(2,4)=ui->lineEdit_tar_xz_3->text().toDouble(); 
    tols(2,5)=ui->lineEdit_tar_yz_3->text().toDouble();
...
double TolDialogHUMP::getWMaxSoftHand()
{
    return ui->lineEdit_w_max_SoftHand->text().toDouble();
}

double TolDialogHUMP::getAlphaMaxSoftHand()
{
    return ui->lineEdit_alpha_max_SoftHand->text().toDouble();
}

void TolDialogHUMP::setWMaxSoftHand(double w)
{
...
bool TolDialogHUMP::getRetreatFinalValues_Info(){
    return ui->Retreat_Final_Values->isChecked();
}
...
#if HAND != 0 && HAND != 1
void TolDialogHUMP::setTypeHand(int typeHand){
    if(typeHand == 2){
        ui->checkBox_EG->setEnabled(true);
        ui->checkBox_QbSoftHand->setEnabled(true);

        ui->checkBox_EG->setChecked(true);
        ui->checkBox_QbSoftHand->setChecked(false);
        ...
        ui->checkBox_EG->setChecked(false);
        ui->checkBox_QbSoftHand->setChecked(true);
        adaptationQbSoftHand();
    }
}
#endif
   ...
   if(f.open( QIODevice::WriteOnly )){
       ...
       stream << "max_acceleration="<< ui->lineEdit_alpha_max->text().toStdString().c_str() <<endl;
        ...
        if(ui->checkBox_EG->isChecked()){
         ...
         stream << "max_acceleration_gripper="<< ui->lineEdit_alpha_max_gripper->text().toStdString().c_str() <<endl;
        }else if(ui->checkBox_QbSoftHand->isChecked()){
         stream << "max_velocity_SoftHand="<< ui->lineEdit_w_max_SoftHand->text().toStdString().c_str() <<endl;
         stream << "max_acceleration_SoftHand="<< ui->lineEdit_alpha_max_SoftHand->text().toStdString().c_str() <<endl;
        }
       #endif
       ...
       if(ui->checkBox_EG->isChecked()){stream << "set_EG=true" << endl;}else{stream << "set_EG=false" << endl;}
       if(ui->checkBox_QbSoftHand->isChecked()){stream << "set_Qb=true" << endl;}else{stream << "set_Qb=false" << endl;}
       ...
       #else
        if(ui->checkBox_QbSoftHand->isChecked()){
             stream << "Hand_1_1=" << ui->lineEdit_hand_Qb_1_1->text().toStdString().c_str() << endl;
             stream << "Hand_1_2=" << ui->lineEdit_hand_Qb_1_2->text().toStdString().c_str() << endl;
             stream << "Hand_1_3=" << ui->lineEdit_hand_Qb_1_3->text().toStdString().c_str() << endl;
             stream << "Hand_1_4=" << ui->lineEdit_hand_Qb_1_4->text().toStdString().c_str() << endl;
             stream << "Hand_1_5=" << ui->lineEdit_hand_Qb_1_5->text().toStdString().c_str() << endl;
             stream << "Hand_2_1=" << ui->lineEdit_hand_Qb_2_1->text().toStdString().c_str() << endl;
             stream << "Hand_2_2=" << ui->lineEdit_hand_Qb_2_2->text().toStdString().c_str() << endl;
             stream << "Hand_2_3=" << ui->lineEdit_hand_Qb_2_3->text().toStdString().c_str() << endl;
             stream << "Hand_2_4=" << ui->lineEdit_hand_Qb_2_4->text().toStdString().c_str() << endl;
             stream << "Hand_2_5=" << ui->lineEdit_hand_Qb_2_5->text().toStdString().c_str() << endl;
             stream << "Hand_3_1=" << ui->lineEdit_hand_Qb_3_1->text().toStdString().c_str() << endl;
             stream << "Hand_3_2=" << ui->lineEdit_hand_Qb_3_2->text().toStdString().c_str() << endl;
             stream << "Hand_3_3=" << ui->lineEdit_hand_Qb_3_3->text().toStdString().c_str() << endl;
             stream << "Hand_3_4=" << ui->lineEdit_hand_Qb_3_4->text().toStdString().c_str() << endl;
             stream << "Hand_3_5=" << ui->lineEdit_hand_Qb_3_5->text().toStdString().c_str() << endl;
             stream << "Hand_4_1=" << ui->lineEdit_hand_Qb_4_1->text().toStdString().c_str() << endl;
             stream << "Hand_4_2=" << ui->lineEdit_hand_Qb_4_2->text().toStdString().c_str() << endl;
             stream << "Hand_4_3=" << ui->lineEdit_hand_Qb_4_3->text().toStdString().c_str() << endl;
             stream << "Hand_4_4=" << ui->lineEdit_hand_Qb_4_4->text().toStdString().c_str() << endl;
             stream << "Hand_4_5=" << ui->lineEdit_hand_Qb_4_5->text().toStdString().c_str() << endl;
        }else if(ui->checkBox_EG->isChecked()){
            stream << "Hand_1_1=" << ui->lineEdit_hand_EG_1_1->text().toStdString().c_str() << endl;
            stream << "Hand_1_2=" << ui->lineEdit_hand_EG_1_2->text().toStdString().c_str() << endl;
        }
       #endif
       #if HAND == 0 || HAND == 1
       ...
       #else
        if(ui->checkBox_QbSoftHand->isChecked()){
            stream << "Hand_tip_Qb_1=" << ui->lineEdit_hand_Qb_tip_1->text().toStdString().c_str() << endl;
            stream << "Hand_tip_Qb_2=" << ui->lineEdit_hand_Qb_tip_2->text().toStdString().c_str() << endl;
            stream << "Hand_tip_Qb_3=" << ui->lineEdit_hand_Qb_tip_3->text().toStdString().c_str() << endl;
            stream << "Hand_tip_Qb_4=" << ui->lineEdit_hand_Qb_tip_4->text().toStdString().c_str() << endl;
            stream << "Hand_tip_Qb_5=" << ui->lineEdit_hand_Qb_tip_5->text().toStdString().c_str() << endl;
        }else if(ui->checkBox_EG->isChecked()){
            stream << "Hand_tip_EG_1=" << ui->lineEdit_hand_EG_tip_1->text().toStdString().c_str() << endl;
            stream << "Hand_tip_EG_2=" << ui->lineEdit_hand_EG_tip_2->text().toStdString().c_str() << endl;
        }
       #endif
       ...
       if (ui->Retreat_Final_Values->isChecked()){ stream << "Retreat_Final_Values=true"<< endl;}else{stream << "Retreat_Final_Values=false"<< endl;}
       ...
       stream << "grasp_offset=" << ui->lineEdit_grasp_offset->text().toStdString().c_str() << endl;
    ...
    if(f.open( QIODevice::ReadOnly )){
        ...
        while(!stream.atEnd()){
            ...
            if(line.at(0)!=QChar('#')){
                ...
                if (QString::compare(fields.at(0),QString("Shoulder_radius"),Qt::CaseInsensitive)==0){
                ...
                #if HAND == 0 || HAND == 1
                    if(QString::compare(fields.at(0),QString("Hand_1_1"),Qt::CaseInsensitive)==0){
                    ...
                    if(ui->checkBox_QbSoftHand->isChecked()){
                        if(QString::compare(fields.at(0),QString("Hand_1_1"),Qt::CaseInsensitive)==0){
                        ui->lineEdit_hand_Qb_1_1->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_1_2"),Qt::CaseInsensitive)==0){
                        ui->lineEdit_hand_Qb_1_2->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_1_3"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_1_3->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_1_4"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_1_4->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_1_5"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_1_5->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_2_1"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_2_1->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_2_2"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_2_2->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_2_3"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_2_3->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_2_4"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_2_4->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_2_5"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_2_5->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_3_1"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_3_1->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_3_2"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_3_2->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_3_3"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_3_3->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_3_4"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_3_4->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_3_5"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_3_5->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_4_1"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_4_1->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_4_2"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_4_2->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_4_3"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_4_3->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_4_4"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_4_4->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_4_5"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_4_5->setText(fields.at(1));
                        }
                    }else if(ui->checkBox_EG->isChecked()){
                        if(QString::compare(fields.at(0),QString("Hand_1_1"),Qt::CaseInsensitive)==0){
                            ui->lineEdit_hand_EG_1_1->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_1_2"),Qt::CaseInsensitive)==0){
                            ui->lineEdit_hand_EG_1_2->setText(fields.at(1));
                        }
                    }
                #endif

                #if HAND == 0 || HAND == 1
                    if(QString::compare(fields.at(0),QString("Hand_tip_1"),Qt::CaseInsensitive)==0){
                    ...
                    if(ui->checkBox_QbSoftHand->isChecked()){
                        if(QString::compare(fields.at(0),QString("Hand_tip_1"),Qt::CaseInsensitive)==0){
                            ui->lineEdit_hand_Qb_tip_1->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_tip_2"),Qt::CaseInsensitive)==0){
                            ui->lineEdit_hand_Qb_tip_2->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_tip_3"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_tip_3->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_tip_4"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_tip_4->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_tip_5"),Qt::CaseInsensitive)==0){
                          ui->lineEdit_hand_Qb_tip_5->setText(fields.at(1));
                        }
                    }else if(ui->checkBox_EG->isChecked()){
                        if(QString::compare(fields.at(0),QString("Hand_tip_1"),Qt::CaseInsensitive)==0){
                            ui->lineEdit_hand_EG_tip_1->setText(fields.at(1));
                        }else if(QString::compare(fields.at(0),QString("Hand_tip_2"),Qt::CaseInsensitive)==0){
                            ui->lineEdit_hand_EG_tip_2->setText(fields.at(1));
                        }
                    }
                #endif
                if(QString::compare(fields.at(0),QString("lambda_1"),Qt::CaseInsensitive)==0){
                ...
                #if HAND == 0 || HAND == 1
                  if(QString::compare(fields.at(0),QString("lambda_9"),Qt::CaseInsensitive)==0){
                ...
                #endif
                if(QString::compare(fields.at(0),QString("init_vel_1"),Qt::CaseInsensitive)==0){
                ...
                #if HAND == 0 || HAND == 1
                  if(QString::compare(fields.at(0),QString("init_vel_9"),Qt::CaseInsensitive)==0){
                ...
                #endif
                if(QString::compare(fields.at(0),QString("final_vel_1"),Qt::CaseInsensitive)==0){
                ...
                #else
                    if(ui->checkBox_QbSoftHand->isChecked()){
                        if(QString::compare(fields.at(0),QString("final_vel_9"),Qt::CaseInsensitive)==0){
                            ui->lineEdit_final_vel_9->setText(fields.at(1));
                        }
                    }
                #endif
                if(QString::compare(fields.at(0),QString("init_acc_1"),Qt::CaseInsensitive)==0){
                ...
                #else
                    if(ui->checkBox_QbSoftHand->isChecked()){
                        if(QString::compare(fields.at(0),QString("init_acc_9"),Qt::CaseInsensitive)==0){
                            ui->lineEdit_init_acc_9->setText(fields.at(1));
                        }
                    }
                #endif
                if(QString::compare(fields.at(0),QString("final_acc_1"),Qt::CaseInsensitive)==0){
                ...
                #else
                    if(ui->checkBox_QbSoftHand->isChecked()){
                        if(QString::compare(fields.at(0),QString("final_acc_9"),Qt::CaseInsensitive)==0){
                            ui->lineEdit_final_acc_9->setText(fields.at(1));
                        }
                    }
                #endif
                if(QString::compare(fields.at(0),QString("Retreat_Final_Values"),Qt::CaseInsensitive)==0){
                     if(QString::compare(fields.at(1),QString("false\n"),Qt::CaseInsensitive)==0){
                         ui->Retreat_Final_Values->setChecked(false);
                     }else{
                         ui->Retreat_Final_Values->setChecked(true);
                     }
                ...
                }else if(QString::compare(fields.at(0),QString("grasp_offset"),Qt::CaseInsensitive)==0){
                    ui->lineEdit_grasp_offset->setText(fields.at(1));
                ...
                if(ui->checkBox_QbSoftHand->isChecked()){
                    if(QString::compare(fields.at(0),QString("final_hand_2"),Qt::CaseInsensitive)==0){
                        ui->lineEdit_final_hand_2->setText(fields.at(1));
                    }
                }
                #if HAND == 0 || HAND == 1
                    if(QString::compare(fields.at(0),QString("final_hand_3"),Qt::CaseInsensitive)==0){
                ...
                #endif
               if(QString::compare(fields.at(0),QString("sel_final"),Qt::CaseInsensitive)==0){
                    if(QString::compare(fields.at(1),QString("false\n"),Qt::CaseInsensitive)==0){
                    ...
                    if(ui->checkBox_EG->isChecked()){
                        ...
                        else if(QString::compare(fields.at(0),QString("max_acceleration_gripper"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_alpha_max_gripper->setText(fields.at(1));
                    }else if(ui->checkBox_QbSoftHand->isChecked()){
                        if(QString::compare(fields.at(0),QString("max_velocity_SoftHand"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_w_max_SoftHand->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("max_acceleration_SoftHand"),Qt::CaseInsensitive)==0)
                ...
                }else if(QString::compare(fields.at(0),QString("set_EG"),Qt::CaseInsensitive)==0){
                    if(QString::compare(fields.at(1),QString("false\n"),Qt::CaseInsensitive)==0)
                        ui->checkBox_EG->setChecked(false);
                    else {
                        ui->checkBox_EG->setChecked(true);
                    }
                }else if(QString::compare(fields.at(0), QString("set_Qb"), Qt::CaseInsensitive)==0){
                    if(QString::compare(fields.at(1),QString("false\n"),Qt::CaseInsensitive)==0)
                        ui->checkBox_QbSoftHand->setChecked(false);
                    else {
                        ui->checkBox_QbSoftHand->setChecked(true);
...
double TolDialogHUMP::getGraspOffset(){
    return ui->lineEdit_grasp_offset->text().toDouble();
}

void TolDialogHUMP::checkEGHand(int state){
    if(state == 0){
        ui->tab_v_a_EG->setEnabled(false);
        ui->tab_EG_fingers->setEnabled(false);
        ui->checkBox_QbSoftHand->setEnabled(true);
    }else {
        ui->checkBox_QbSoftHand->setEnabled(false);
        ui->tab_v_a_EG->setEnabled(true);
        ui->tab_EG_fingers->setEnabled(true);
        ui->tab_v_a_QbSoftHand->setEnabled(false);
        ui->tab_QbSoftHand_fingers->setEnabled(false);
...
void TolDialogHUMP::checkQbHand(int state){
    if(state == 0){
        ui->tab_v_a_QbSoftHand->setEnabled(false);
        ui->tab_QbSoftHand_fingers->setEnabled(false);
        ui->checkBox_EG->setEnabled(true);
    }else {
        ui->checkBox_EG->setEnabled(false);
        ui->tab_v_a_EG->setEnabled(false);
        ui->tab_EG_fingers->setEnabled(false);
        ui->tab_v_a_QbSoftHand->setEnabled(true);
        ui->tab_QbSoftHand_fingers->setEnabled(true);
