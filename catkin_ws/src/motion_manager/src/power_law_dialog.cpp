...
void PowerLawDialog::setupPlots(vector<vector<double> > &hand_position, vector<vector<vector<double> > > &timesteps)
{
    ...
    QVector<double> lnY_tot;
    QVector<double> lnX_tot;
    vector<double> q_tot; 
    vector<double> m_tot; 
    vector<double> r_tot;
    vector<double> q_tot_w; 
    vector<double> m_tot_w; 
    vector<double> r_tot_w;
    vector<double> q_tot_2w; 
    vector<double> m_tot_2w; 
    vector<double> r_tot_2w;
