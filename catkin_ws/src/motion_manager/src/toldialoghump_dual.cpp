    ...
    ui(new Ui::TolDialogHUMPDual)
{
    ...
    #if HAND != 0 && HAND != 1
         QObject::connect(ui->checkBox_EG_right, SIGNAL(stateChanged(int)), this, SLOT(checkEGHand_right(int)));
         QObject::connect(ui->checkBox_QbSoftHand_right, SIGNAL(stateChanged(int)), this, SLOT(checkQbHand_right(int)));
         QObject::connect(ui->checkBox_EG_left, SIGNAL(stateChanged(int)), this, SLOT(checkEGHand_left(int)));
         QObject::connect(ui->checkBox_QbSoftHand_left, SIGNAL(stateChanged(int)), this, SLOT(checkQbHand_left(int)));
    #endif
...
#if HAND != 0 && HAND != 1
void TolDialogHUMPDual::adaptationRightElectricGripper()
{
    //******Disable the joints that aren't used to this type of hand
    ui->tab_fingers_EG_right->setEnabled(true);
    ui->tab_fingers_Qb_right->setEnabled(false);

    ui->groupBox_grasp_offset_right->setEnabled(true);
    ui->groupBox_grasp_offset_left->setEnabled(true);

    //Points of the right hand
    ui->lineEdit_hand_EG_1_1_right->setText(QString::number(25.0));
    ui->lineEdit_hand_EG_1_1_right->setEnabled(true);
    ui->lineEdit_hand_EG_1_2_right->setText(QString::number(25.0));
    ui->lineEdit_hand_EG_1_2_right->setEnabled(true);
    ui->lineEdit_hand_EG_1_3_right->setText(QString::number(0));
    ui->lineEdit_hand_EG_1_3_right->setEnabled(false);

    ui->lineEdit_hand_EG_2_1_right->setText(QString::number(0));
    ui->lineEdit_hand_EG_2_1_right->setEnabled(false);
    ui->lineEdit_hand_EG_2_2_right->setText(QString::number(0));
    ui->lineEdit_hand_EG_2_2_right->setEnabled(false);
    ui->lineEdit_hand_EG_2_3_right->setText(QString::number(0));
    ui->lineEdit_hand_EG_2_3_right->setEnabled(false);

    ui->lineEdit_hand_EG_3_1_right->setText(QString::number(0));
    ui->lineEdit_hand_EG_3_1_right->setEnabled(false);
    ui->lineEdit_hand_EG_3_2_right->setText(QString::number(0));
    ui->lineEdit_hand_EG_3_2_right->setEnabled(false);
    ui->lineEdit_hand_EG_3_3_right->setText(QString::number(0));
    ui->lineEdit_hand_EG_3_3_right->setEnabled(false);

    ui->lineEdit_hand_EG_tip_1_right->setText(QString::number(5.0));
    ui->lineEdit_hand_EG_tip_1_right->setEnabled(true);
    ui->lineEdit_hand_EG_tip_2_right->setText(QString::number(5.0));
    ui->lineEdit_hand_EG_tip_2_right->setEnabled(true);
    ui->lineEdit_hand_EG_tip_3_right->setText(QString::number(0));
    ui->lineEdit_hand_EG_tip_3_right->setEnabled(false);

    // Joint Expense Factors (Right)
    ui->lineEdit_lambda_1_right->setText(QString::number(1.0));
    ui->lineEdit_lambda_1_right->setEnabled(true);
    ui->lineEdit_lambda_2_right->setText(QString::number(1.0));
    ui->lineEdit_lambda_2_right->setEnabled(true);
    ui->lineEdit_lambda_3_right->setText(QString::number(1.0));
    ui->lineEdit_lambda_3_right->setEnabled(true);
    ui->lineEdit_lambda_4_right->setText(QString::number(1.0));
    ui->lineEdit_lambda_4_right->setEnabled(true);
    ui->lineEdit_lambda_5_right->setText(QString::number(1.0));
    ui->lineEdit_lambda_5_right->setEnabled(true);
    ui->lineEdit_lambda_6_right->setText(QString::number(1.0));
    ui->lineEdit_lambda_6_right->setEnabled(true);
    ui->lineEdit_lambda_7_right->setText(QString::number(1.0));
    ui->lineEdit_lambda_7_right->setEnabled(true);
    ui->lineEdit_lambda_8_right->setText(QString::number(1.0));
    ui->lineEdit_lambda_8_right->setEnabled(true);
    ui->lineEdit_lambda_9_right->setText(QString::number(0));
    ui->lineEdit_lambda_9_right->setEnabled(false);
    ui->lineEdit_lambda_10_right->setText(QString::number(0));
    ui->lineEdit_lambda_10_right->setEnabled(false);
    ui->lineEdit_lambda_11_right->setText(QString::number(0));
    ui->lineEdit_lambda_11_right->setEnabled(false);

    //Boundary conditions (Right)
    //init vel
    ui->lineEdit_init_vel_1_right->setText(QString::number(0.0));
    ui->lineEdit_init_vel_1_right->setEnabled(true);
    ui->lineEdit_init_vel_2_right->setText(QString::number(0.0));
    ui->lineEdit_init_vel_2_right->setEnabled(true);
    ui->lineEdit_init_vel_3_right->setText(QString::number(0.0));
    ui->lineEdit_init_vel_3_right->setEnabled(true);
    ui->lineEdit_init_vel_4_right->setText(QString::number(0.0));
    ui->lineEdit_init_vel_4_right->setEnabled(true);
    ui->lineEdit_init_vel_5_right->setText(QString::number(0.0));
    ui->lineEdit_init_vel_5_right->setEnabled(true);
    ui->lineEdit_init_vel_6_right->setText(QString::number(0.0));
    ui->lineEdit_init_vel_6_right->setEnabled(true);
    ui->lineEdit_init_vel_7_right->setText(QString::number(0.0));
    ui->lineEdit_init_vel_7_right->setEnabled(true);
    ui->lineEdit_init_vel_8_right->setText(QString::number(0.0));
    ui->lineEdit_init_vel_8_right->setEnabled(true);
    ui->lineEdit_init_vel_9_right->setText(QString::number(0));
    ui->lineEdit_init_vel_9_right->setEnabled(false);
    ui->lineEdit_init_vel_10_right->setText(QString::number(0));
    ui->lineEdit_init_vel_10_right->setEnabled(false);
    ui->lineEdit_init_vel_11_right->setText(QString::number(0));
    ui->lineEdit_init_vel_11_right->setEnabled(false);
    //final vel
    ui->lineEdit_final_vel_1_right->setText(QString::number(0.0));
    ui->lineEdit_final_vel_1_right->setEnabled(true);
    ui->lineEdit_final_vel_2_right->setText(QString::number(0.0));
    ui->lineEdit_final_vel_2_right->setEnabled(true);
    ui->lineEdit_final_vel_3_right->setText(QString::number(0.0));
    ui->lineEdit_final_vel_3_right->setEnabled(true);
    ui->lineEdit_final_vel_4_right->setText(QString::number(0.0));
    ui->lineEdit_final_vel_4_right->setEnabled(true);
    ui->lineEdit_final_vel_5_right->setText(QString::number(0.0));
    ui->lineEdit_final_vel_5_right->setEnabled(true);
    ui->lineEdit_final_vel_6_right->setText(QString::number(0.0));
    ui->lineEdit_final_vel_6_right->setEnabled(true);
    ui->lineEdit_final_vel_7_right->setText(QString::number(0.0));
    ui->lineEdit_final_vel_7_right->setEnabled(true);
    ui->lineEdit_final_vel_8_right->setText(QString::number(0.0));
    ui->lineEdit_final_vel_8_right->setEnabled(true);
    ui->lineEdit_final_vel_9_right->setText(QString::number(0));
    ui->lineEdit_final_vel_9_right->setEnabled(false);
    ui->lineEdit_final_vel_10_right->setText(QString::number(0));
    ui->lineEdit_final_vel_10_right->setEnabled(false);
    ui->lineEdit_final_vel_11_right->setText(QString::number(0));
    ui->lineEdit_final_vel_11_right->setEnabled(false);
    //init acc
    ui->lineEdit_init_acc_1_right->setText(QString::number(0.0));
    ui->lineEdit_init_acc_1_right->setEnabled(true);
    ui->lineEdit_init_acc_2_right->setText(QString::number(0.0));
    ui->lineEdit_init_acc_2_right->setEnabled(true);
    ui->lineEdit_init_acc_3_right->setText(QString::number(0.0));
    ui->lineEdit_init_acc_3_right->setEnabled(true);
    ui->lineEdit_init_acc_4_right->setText(QString::number(0.0));
    ui->lineEdit_init_acc_4_right->setEnabled(true);
    ui->lineEdit_init_acc_5_right->setText(QString::number(0.0));
    ui->lineEdit_init_acc_5_right->setEnabled(true);
    ui->lineEdit_init_acc_6_right->setText(QString::number(0.0));
    ui->lineEdit_init_acc_6_right->setEnabled(true);
    ui->lineEdit_init_acc_7_right->setText(QString::number(0.0));
    ui->lineEdit_init_acc_7_right->setEnabled(true);
    ui->lineEdit_init_acc_8_right->setText(QString::number(0.0));
    ui->lineEdit_init_acc_8_right->setEnabled(true);
    ui->lineEdit_init_acc_9_right->setText(QString::number(0));
    ui->lineEdit_init_acc_9_right->setEnabled(false);
    ui->lineEdit_init_acc_10_right->setText(QString::number(0));
    ui->lineEdit_init_acc_10_right->setEnabled(false);
    ui->lineEdit_init_acc_11_right->setText(QString::number(0));
    ui->lineEdit_init_acc_11_right->setEnabled(false);
    //final acc
    ui->lineEdit_final_acc_1_right->setText(QString::number(0.0));
    ui->lineEdit_final_acc_1_right->setEnabled(true);
    ui->lineEdit_final_acc_2_right->setText(QString::number(0.0));
    ui->lineEdit_final_acc_2_right->setEnabled(true);
    ui->lineEdit_final_acc_3_right->setText(QString::number(0.0));
    ui->lineEdit_final_acc_3_right->setEnabled(true);
    ui->lineEdit_final_acc_4_right->setText(QString::number(0.0));
    ui->lineEdit_final_acc_4_right->setEnabled(true);
    ui->lineEdit_final_acc_5_right->setText(QString::number(0.0));
    ui->lineEdit_final_acc_5_right->setEnabled(true);
    ui->lineEdit_final_acc_6_right->setText(QString::number(0.0));
    ui->lineEdit_final_acc_6_right->setEnabled(true);
    ui->lineEdit_final_acc_7_right->setText(QString::number(0.0));
    ui->lineEdit_final_acc_7_right->setEnabled(true);
    ui->lineEdit_final_acc_8_right->setText(QString::number(0.0));
    ui->lineEdit_final_acc_8_right->setEnabled(true);
    ui->lineEdit_final_acc_9_right->setText(QString::number(0));
    ui->lineEdit_final_acc_9_right->setEnabled(false);
    ui->lineEdit_final_acc_10_right->setText(QString::number(0));
    ui->lineEdit_final_acc_10_right->setEnabled(false);
    ui->lineEdit_final_acc_11_right->setText(QString::number(0));
    ui->lineEdit_final_acc_11_right->setEnabled(false);

    //Final Hand Posture (Right)
    ui->lineEdit_final_hand_1_right->setText(QString::number(0.0));
    ui->lineEdit_final_hand_1_right->setEnabled(true);
    ui->lineEdit_final_hand_2_right->setText(QString::number(0));
    ui->lineEdit_final_hand_2_right->setEnabled(false);
    ui->lineEdit_final_hand_3_right->setText(QString::number(0));
    ui->lineEdit_final_hand_3_right->setEnabled(false);
    ui->lineEdit_final_hand_4_right->setText(QString::number(0));
    ui->lineEdit_final_hand_4_right->setEnabled(false);
}

void TolDialogHUMPDual::adaptationLeftElectricGripper()
{
    ui->tab_fingers_EG_left->setEnabled(true);
    ui->tab_fingers_Qb_left->setEnabled(false);

    ui->groupBox_grasp_offset_left->setEnabled(true);
    ui->groupBox_grasp_offset_right->setEnabled(true);

    //Points of the left hand
    ui->lineEdit_hand_EG_1_1_left->setText(QString::number(25.0));
    ui->lineEdit_hand_EG_1_1_left->setEnabled(true);
    ui->lineEdit_hand_EG_1_2_left->setText(QString::number(25.0));
    ui->lineEdit_hand_EG_1_2_left->setEnabled(true);
    ui->lineEdit_hand_EG_1_3_left->setText(QString::number(0));
    ui->lineEdit_hand_EG_1_3_left->setEnabled(false);

    ui->lineEdit_hand_EG_2_1_left->setText(QString::number(0));
    ui->lineEdit_hand_EG_2_1_left->setEnabled(false);
    ui->lineEdit_hand_EG_2_2_left->setText(QString::number(0));
    ui->lineEdit_hand_EG_2_2_left->setEnabled(false);
    ui->lineEdit_hand_EG_2_3_left->setText(QString::number(0));
    ui->lineEdit_hand_EG_2_3_left->setEnabled(false);

    ui->lineEdit_hand_EG_3_1_left->setText(QString::number(0));
    ui->lineEdit_hand_EG_3_1_left->setEnabled(false);
    ui->lineEdit_hand_EG_3_2_left->setText(QString::number(0));
    ui->lineEdit_hand_EG_3_2_left->setEnabled(false);
    ui->lineEdit_hand_EG_3_3_left->setText(QString::number(0));
    ui->lineEdit_hand_EG_3_3_left->setEnabled(false);

    ui->lineEdit_hand_EG_tip_1_left->setText(QString::number(5.0));
    ui->lineEdit_hand_EG_tip_1_left->setEnabled(true);
    ui->lineEdit_hand_EG_tip_2_left->setText(QString::number(5.0));
    ui->lineEdit_hand_EG_tip_2_left->setEnabled(true);
    ui->lineEdit_hand_EG_tip_3_left->setText(QString::number(0));
    ui->lineEdit_hand_EG_tip_3_left->setEnabled(false);

    // Joint Expense Factors (left)
    ui->lineEdit_lambda_1_left->setText(QString::number(1.0));
    ui->lineEdit_lambda_1_left->setEnabled(true);
    ui->lineEdit_lambda_2_left->setText(QString::number(1.0));
    ui->lineEdit_lambda_2_left->setEnabled(true);
    ui->lineEdit_lambda_3_left->setText(QString::number(1.0));
    ui->lineEdit_lambda_3_left->setEnabled(true);
    ui->lineEdit_lambda_4_left->setText(QString::number(1.0));
    ui->lineEdit_lambda_4_left->setEnabled(true);
    ui->lineEdit_lambda_5_left->setText(QString::number(1.0));
    ui->lineEdit_lambda_5_left->setEnabled(true);
    ui->lineEdit_lambda_6_left->setText(QString::number(1.0));
    ui->lineEdit_lambda_6_left->setEnabled(true);
    ui->lineEdit_lambda_7_left->setText(QString::number(1.0));
    ui->lineEdit_lambda_7_left->setEnabled(true);
    ui->lineEdit_lambda_8_left->setText(QString::number(1.0));
    ui->lineEdit_lambda_8_left->setEnabled(true);
    ui->lineEdit_lambda_9_left->setText(QString::number(0));
    ui->lineEdit_lambda_9_left->setEnabled(false);
    ui->lineEdit_lambda_10_left->setText(QString::number(0));
    ui->lineEdit_lambda_10_left->setEnabled(false);
    ui->lineEdit_lambda_11_left->setText(QString::number(0));
    ui->lineEdit_lambda_11_left->setEnabled(false);

    //Boundary conditions (left)
    //init vel
    ui->lineEdit_init_vel_1_left->setText(QString::number(0.0));
    ui->lineEdit_init_vel_1_left->setEnabled(true);
    ui->lineEdit_init_vel_2_left->setText(QString::number(0.0));
    ui->lineEdit_init_vel_2_left->setEnabled(true);
    ui->lineEdit_init_vel_3_left->setText(QString::number(0.0));
    ui->lineEdit_init_vel_3_left->setEnabled(true);
    ui->lineEdit_init_vel_4_left->setText(QString::number(0.0));
    ui->lineEdit_init_vel_4_left->setEnabled(true);
    ui->lineEdit_init_vel_5_left->setText(QString::number(0.0));
    ui->lineEdit_init_vel_5_left->setEnabled(true);
    ui->lineEdit_init_vel_6_left->setText(QString::number(0.0));
    ui->lineEdit_init_vel_6_left->setEnabled(true);
    ui->lineEdit_init_vel_7_left->setText(QString::number(0.0));
    ui->lineEdit_init_vel_7_left->setEnabled(true);
    ui->lineEdit_init_vel_8_left->setText(QString::number(0.0));
    ui->lineEdit_init_vel_8_left->setEnabled(true);
    ui->lineEdit_init_vel_9_left->setText(QString::number(0));
    ui->lineEdit_init_vel_9_left->setEnabled(false);
    ui->lineEdit_init_vel_10_left->setText(QString::number(0));
    ui->lineEdit_init_vel_10_left->setEnabled(false);
    ui->lineEdit_init_vel_11_left->setText(QString::number(0));
    ui->lineEdit_init_vel_11_left->setEnabled(false);
    //final vel
    ui->lineEdit_final_vel_1_left->setText(QString::number(0.0));
    ui->lineEdit_final_vel_1_left->setEnabled(true);
    ui->lineEdit_final_vel_2_left->setText(QString::number(0.0));
    ui->lineEdit_final_vel_2_left->setEnabled(true);
    ui->lineEdit_final_vel_3_left->setText(QString::number(0.0));
    ui->lineEdit_final_vel_3_left->setEnabled(true);
    ui->lineEdit_final_vel_4_left->setText(QString::number(0.0));
    ui->lineEdit_final_vel_4_left->setEnabled(true);
    ui->lineEdit_final_vel_5_left->setText(QString::number(0.0));
    ui->lineEdit_final_vel_5_left->setEnabled(true);
    ui->lineEdit_final_vel_6_left->setText(QString::number(0.0));
    ui->lineEdit_final_vel_6_left->setEnabled(true);
    ui->lineEdit_final_vel_7_left->setText(QString::number(0.0));
    ui->lineEdit_final_vel_7_left->setEnabled(true);
    ui->lineEdit_final_vel_8_left->setText(QString::number(0.0));
    ui->lineEdit_final_vel_8_left->setEnabled(true);
    ui->lineEdit_final_vel_9_left->setText(QString::number(0));
    ui->lineEdit_final_vel_9_left->setEnabled(false);
    ui->lineEdit_final_vel_10_left->setText(QString::number(0));
    ui->lineEdit_final_vel_10_left->setEnabled(false);
    ui->lineEdit_final_vel_11_left->setText(QString::number(0));
    ui->lineEdit_final_vel_11_left->setEnabled(false);
    //init acc
    ui->lineEdit_init_acc_1_left->setText(QString::number(0.0));
    ui->lineEdit_init_acc_1_left->setEnabled(true);
    ui->lineEdit_init_acc_2_left->setText(QString::number(0.0));
    ui->lineEdit_init_acc_2_left->setEnabled(true);
    ui->lineEdit_init_acc_3_left->setText(QString::number(0.0));
    ui->lineEdit_init_acc_3_left->setEnabled(true);
    ui->lineEdit_init_acc_4_left->setText(QString::number(0.0));
    ui->lineEdit_init_acc_4_left->setEnabled(true);
    ui->lineEdit_init_acc_5_left->setText(QString::number(0.0));
    ui->lineEdit_init_acc_5_left->setEnabled(true);
    ui->lineEdit_init_acc_6_left->setText(QString::number(0.0));
    ui->lineEdit_init_acc_6_left->setEnabled(true);
    ui->lineEdit_init_acc_7_left->setText(QString::number(0.0));
    ui->lineEdit_init_acc_7_left->setEnabled(true);
    ui->lineEdit_init_acc_8_left->setText(QString::number(0.0));
    ui->lineEdit_init_acc_8_left->setEnabled(true);
    ui->lineEdit_init_acc_9_left->setText(QString::number(0));
    ui->lineEdit_init_acc_9_left->setEnabled(false);
    ui->lineEdit_init_acc_10_left->setText(QString::number(0));
    ui->lineEdit_init_acc_10_left->setEnabled(false);
    ui->lineEdit_init_acc_11_left->setText(QString::number(0));
    ui->lineEdit_init_acc_11_left->setEnabled(false);
    //final acc
    ui->lineEdit_final_acc_1_left->setText(QString::number(0.0));
    ui->lineEdit_final_acc_1_left->setEnabled(true);
    ui->lineEdit_final_acc_2_left->setText(QString::number(0.0));
    ui->lineEdit_final_acc_2_left->setEnabled(true);
    ui->lineEdit_final_acc_3_left->setText(QString::number(0.0));
    ui->lineEdit_final_acc_3_left->setEnabled(true);
    ui->lineEdit_final_acc_4_left->setText(QString::number(0.0));
    ui->lineEdit_final_acc_4_left->setEnabled(true);
    ui->lineEdit_final_acc_5_left->setText(QString::number(0.0));
    ui->lineEdit_final_acc_5_left->setEnabled(true);
    ui->lineEdit_final_acc_6_left->setText(QString::number(0.0));
    ui->lineEdit_final_acc_6_left->setEnabled(true);
    ui->lineEdit_final_acc_7_left->setText(QString::number(0.0));
    ui->lineEdit_final_acc_7_left->setEnabled(true);
    ui->lineEdit_final_acc_8_left->setText(QString::number(0.0));
    ui->lineEdit_final_acc_8_left->setEnabled(true);
    ui->lineEdit_final_acc_9_left->setText(QString::number(0));
    ui->lineEdit_final_acc_9_left->setEnabled(false);
    ui->lineEdit_final_acc_10_left->setText(QString::number(0));
    ui->lineEdit_final_acc_10_left->setEnabled(false);
    ui->lineEdit_final_acc_11_left->setText(QString::number(0));
    ui->lineEdit_final_acc_11_left->setEnabled(false);

    //Final Hand Posture (left)
    ui->lineEdit_final_hand_1_left->setText(QString::number(0.0));
    ui->lineEdit_final_hand_1_left->setEnabled(true);
    ui->lineEdit_final_hand_2_left->setText(QString::number(0));
    ui->lineEdit_final_hand_2_left->setEnabled(false);
    ui->lineEdit_final_hand_3_left->setText(QString::number(0));
    ui->lineEdit_final_hand_3_left->setEnabled(false);
    ui->lineEdit_final_hand_4_left->setText(QString::number(0));
    ui->lineEdit_final_hand_4_left->setEnabled(false);
}

void TolDialogHUMPDual::adaptationRightQbSoftHand(){

    ui->tab_fingers_EG_right->setEnabled(false);
    ui->tab_fingers_Qb_right->setEnabled(true);

    ui->groupBox_grasp_offset_right->setEnabled(true);
    ui->groupBox_grasp_offset_left->setEnabled(true);

    ui->lineEdit_hand_Qb_1_1_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_1_right->setEnabled(true);
    ui->lineEdit_hand_Qb_2_1_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_1_right->setEnabled(true);
    ui->lineEdit_hand_Qb_3_1_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_1_right->setEnabled(true);
    ui->lineEdit_hand_Qb_4_1_right->setText(QString::number(0.0));
    ui->lineEdit_hand_Qb_4_1_right->setEnabled(false);

    ui->lineEdit_hand_Qb_1_2_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_2_right->setEnabled(true);
    ui->lineEdit_hand_Qb_2_2_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_2_right->setEnabled(true);
    ui->lineEdit_hand_Qb_3_2_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_2_right->setEnabled(true);
    ui->lineEdit_hand_Qb_4_2_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_4_2_right->setEnabled(true);

    ui->lineEdit_hand_Qb_1_3_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_3_right->setEnabled(true);
    ui->lineEdit_hand_Qb_2_3_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_3_right->setEnabled(true);
    ui->lineEdit_hand_Qb_3_3_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_3_right->setEnabled(true);
    ui->lineEdit_hand_Qb_4_3_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_4_3_right->setEnabled(true);

    ui->lineEdit_hand_Qb_1_4_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_4_right->setEnabled(true);
    ui->lineEdit_hand_Qb_2_4_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_4_right->setEnabled(true);
    ui->lineEdit_hand_Qb_3_4_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_4_right->setEnabled(true);
    ui->lineEdit_hand_Qb_4_4_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_4_4_right->setEnabled(true);

    ui->lineEdit_hand_Qb_1_5_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_5_right->setEnabled(true);
    ui->lineEdit_hand_Qb_2_5_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_5_right->setEnabled(true);
    ui->lineEdit_hand_Qb_3_5_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_5_right->setEnabled(true);
    ui->lineEdit_hand_Qb_4_5_right->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_4_5_right->setEnabled(true);

    ui->lineEdit_hand_Qb_tip_1_right->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_1_right->setEnabled(true);
    ui->lineEdit_hand_Qb_tip_2_right->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_2_right->setEnabled(true);
    ui->lineEdit_hand_Qb_tip_3_right->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_3_right->setEnabled(true);
    ui->lineEdit_hand_Qb_tip_4_right->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_4_right->setEnabled(true);
    ui->lineEdit_hand_Qb_tip_5_right->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_5_right->setEnabled(true);

    // Right Joint Expende Factors
    ui->lineEdit_lambda_1_right->setText(QString::number(1.0));
    ui->lineEdit_lambda_1_right->setEnabled(true);
    ui->lineEdit_lambda_2_right->setText(QString::number(1.0));
    ui->lineEdit_lambda_2_right->setEnabled(true);
    ...
    ui->lineEdit_lambda_8_right->setText(QString::number(1.0));
    ui->lineEdit_lambda_8_right->setEnabled(true);
    ui->lineEdit_lambda_9_right->setText(QString::number(1.0));
    ui->lineEdit_lambda_9_right->setEnabled(true);
    ui->lineEdit_lambda_10_right->setText(QString::number(0.0));
    ui->lineEdit_lambda_10_right->setEnabled(false);
    ui->lineEdit_lambda_11_right->setText(QString::number(0.0));
    ui->lineEdit_lambda_11_right->setEnabled(false);

    //Right Boundary Conditions
    //init vel
    ui->lineEdit_init_vel_1_right->setText(QString::number(0));
    ui->lineEdit_init_vel_1_right->setEnabled(true);
    ui->lineEdit_init_vel_2_right->setText(QString::number(0));
    ui->lineEdit_init_vel_2_right->setEnabled(true);
    ui->lineEdit_init_vel_3_right->setText(QString::number(0));
    ui->lineEdit_init_vel_3_right->setEnabled(true);
    ui->lineEdit_init_vel_4_right->setText(QString::number(0));
    ui->lineEdit_init_vel_4_right->setEnabled(true);
    ui->lineEdit_init_vel_5_right->setText(QString::number(0));
    ui->lineEdit_init_vel_5_right->setEnabled(true);
    ui->lineEdit_init_vel_6_right->setText(QString::number(0));
    ui->lineEdit_init_vel_6_right->setEnabled(true);
    ui->lineEdit_init_vel_7_right->setText(QString::number(0));
    ui->lineEdit_init_vel_7_right->setEnabled(true);
    ui->lineEdit_init_vel_8_right->setText(QString::number(0));
    ui->lineEdit_init_vel_8_right->setEnabled(true);
    ui->lineEdit_init_vel_9_right->setText(QString::number(0));
    ui->lineEdit_init_vel_9_right->setEnabled(true);
    ui->lineEdit_init_vel_10_right->setText(QString::number(0));
    ui->lineEdit_init_vel_10_right->setEnabled(false);
    ui->lineEdit_init_vel_11_right->setText(QString::number(0));
    ui->lineEdit_init_vel_11_right->setEnabled(false);
    //final vel
    ui->lineEdit_final_vel_1_right->setText(QString::number(0));
    ui->lineEdit_final_vel_1_right->setEnabled(true);
    ui->lineEdit_final_vel_2_right->setText(QString::number(0));
    ui->lineEdit_final_vel_2_right->setEnabled(true);
    ui->lineEdit_final_vel_3_right->setText(QString::number(0));
    ui->lineEdit_final_vel_3_right->setEnabled(true);
    ui->lineEdit_final_vel_4_right->setText(QString::number(0));
    ui->lineEdit_final_vel_4_right->setEnabled(true);
    ui->lineEdit_final_vel_5_right->setText(QString::number(0));
    ui->lineEdit_final_vel_5_right->setEnabled(true);
    ui->lineEdit_final_vel_6_right->setText(QString::number(0));
    ui->lineEdit_final_vel_6_right->setEnabled(true);
    ui->lineEdit_final_vel_7_right->setText(QString::number(0));
    ui->lineEdit_final_vel_7_right->setEnabled(true);
    ui->lineEdit_final_vel_8_right->setText(QString::number(0));
    ui->lineEdit_final_vel_8_right->setEnabled(true);
    ui->lineEdit_final_vel_9_right->setText(QString::number(0));
    ui->lineEdit_final_vel_9_right->setEnabled(true);
    ui->lineEdit_final_vel_10_right->setText(QString::number(0));
    ui->lineEdit_final_vel_10_right->setEnabled(false);
    ui->lineEdit_final_vel_11_right->setText(QString::number(0));
    ui->lineEdit_final_vel_11_right->setEnabled(false);
    //init acc
    ui->lineEdit_init_acc_1_right->setText(QString::number(0));
    ui->lineEdit_init_acc_1_right->setEnabled(true);
    ui->lineEdit_init_acc_2_right->setText(QString::number(0));
    ui->lineEdit_init_acc_2_right->setEnabled(true);
    ui->lineEdit_init_acc_3_right->setText(QString::number(0));
    ui->lineEdit_init_acc_3_right->setEnabled(true);
    ui->lineEdit_init_acc_4_right->setText(QString::number(0));
    ui->lineEdit_init_acc_4_right->setEnabled(true);
    ui->lineEdit_init_acc_5_right->setText(QString::number(0));
    ui->lineEdit_init_acc_5_right->setEnabled(true);
    ui->lineEdit_init_acc_6_right->setText(QString::number(0));
    ui->lineEdit_init_acc_6_right->setEnabled(true);
    ui->lineEdit_init_acc_7_right->setText(QString::number(0));
    ui->lineEdit_init_acc_7_right->setEnabled(true);
    ui->lineEdit_init_acc_8_right->setText(QString::number(0));
    ui->lineEdit_init_acc_8_right->setEnabled(true);
    ui->lineEdit_init_acc_9_right->setText(QString::number(0));
    ui->lineEdit_init_acc_9_right->setEnabled(true);
    ui->lineEdit_init_acc_10_right->setText(QString::number(0));
    ui->lineEdit_init_acc_10_right->setEnabled(false);
    ui->lineEdit_init_acc_11_right->setText(QString::number(0));
    ui->lineEdit_init_acc_11_right->setEnabled(false);
    //final acc
    ui->lineEdit_final_acc_1_right->setText(QString::number(0));
    ui->lineEdit_final_acc_1_right->setEnabled(true);
    ui->lineEdit_final_acc_2_right->setText(QString::number(0));
    ui->lineEdit_final_acc_2_right->setEnabled(true);
    ui->lineEdit_final_acc_3_right->setText(QString::number(0));
    ui->lineEdit_final_acc_3_right->setEnabled(true);
    ui->lineEdit_final_acc_4_right->setText(QString::number(0));
    ui->lineEdit_final_acc_4_right->setEnabled(true);
    ui->lineEdit_final_acc_5_right->setText(QString::number(0));
    ui->lineEdit_final_acc_5_right->setEnabled(true);
    ui->lineEdit_final_acc_6_right->setText(QString::number(0));
    ui->lineEdit_final_acc_6_right->setEnabled(true);
    ui->lineEdit_final_acc_7_right->setText(QString::number(0));
    ui->lineEdit_final_acc_7_right->setEnabled(true);
    ui->lineEdit_final_acc_8_right->setText(QString::number(0));
    ui->lineEdit_final_acc_8_right->setEnabled(true);
    ui->lineEdit_final_acc_9_right->setText(QString::number(0));
    ui->lineEdit_final_acc_9_right->setEnabled(true);
    ui->lineEdit_final_acc_10_right->setText(QString::number(0));
    ui->lineEdit_final_acc_10_right->setEnabled(false);
    ui->lineEdit_final_acc_11_right->setText(QString::number(0));
    ui->lineEdit_final_acc_11_right->setEnabled(false);
    ...
    //Final Hand Posture
    ui->lineEdit_final_hand_1_right->setText(QString::number(0));
    ui->lineEdit_final_hand_1_right->setEnabled(true);
    ui->lineEdit_final_hand_2_right->setText(QString::number(0));
    ui->lineEdit_final_hand_2_right->setEnabled(true);
    ui->lineEdit_final_hand_3_right->setText(QString::number(0));
    ui->lineEdit_final_hand_3_right->setEnabled(false);
    ui->lineEdit_final_hand_4_right->setText(QString::number(0));
    ui->lineEdit_final_hand_4_right->setEnabled(false);
...
void TolDialogHUMPDual::adaptationLeftQbSoftHand(){

    ui->tab_fingers_EG_left->setEnabled(false);
    ui->tab_fingers_Qb_left->setEnabled(true);

    ui->groupBox_grasp_offset_left->setEnabled(true);
    ui->groupBox_grasp_offset_right->setEnabled(true);

    ui->lineEdit_hand_Qb_1_1_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_1_left->setEnabled(true);
    ui->lineEdit_hand_Qb_2_1_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_1_left->setEnabled(true);
    ui->lineEdit_hand_Qb_3_1_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_1_left->setEnabled(true);
    ui->lineEdit_hand_Qb_4_1_left->setText(QString::number(0.0));
    ui->lineEdit_hand_Qb_4_1_left->setEnabled(false);

    ui->lineEdit_hand_Qb_1_2_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_2_left->setEnabled(true);
    ui->lineEdit_hand_Qb_2_2_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_2_left->setEnabled(true);
    ui->lineEdit_hand_Qb_3_2_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_2_left->setEnabled(true);
    ui->lineEdit_hand_Qb_4_2_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_4_2_left->setEnabled(true);

    ui->lineEdit_hand_Qb_1_3_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_3_left->setEnabled(true);
    ui->lineEdit_hand_Qb_2_3_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_3_left->setEnabled(true);
    ui->lineEdit_hand_Qb_3_3_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_3_left->setEnabled(true);
    ui->lineEdit_hand_Qb_4_3_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_4_3_left->setEnabled(true);

    ui->lineEdit_hand_Qb_1_4_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_4_left->setEnabled(true);
    ui->lineEdit_hand_Qb_2_4_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_4_left->setEnabled(true);
    ui->lineEdit_hand_Qb_3_4_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_4_left->setEnabled(true);
    ui->lineEdit_hand_Qb_4_4_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_4_4_left->setEnabled(true);

    ui->lineEdit_hand_Qb_1_5_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_1_5_left->setEnabled(true);
    ui->lineEdit_hand_Qb_2_5_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_2_5_left->setEnabled(true);
    ui->lineEdit_hand_Qb_3_5_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_3_5_left->setEnabled(true);
    ui->lineEdit_hand_Qb_4_5_left->setText(QString::number(20.0));
    ui->lineEdit_hand_Qb_4_5_left->setEnabled(true);

    ui->lineEdit_hand_Qb_tip_1_left->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_1_left->setEnabled(true);
    ui->lineEdit_hand_Qb_tip_2_left->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_2_left->setEnabled(true);
    ui->lineEdit_hand_Qb_tip_3_left->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_3_left->setEnabled(true);
    ui->lineEdit_hand_Qb_tip_4_left->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_4_left->setEnabled(true);
    ui->lineEdit_hand_Qb_tip_5_left->setText(QString::number(5.0));
    ui->lineEdit_hand_Qb_tip_5_left->setEnabled(true);

    // left Joint Expende Factors
    ui->lineEdit_lambda_1_left->setText(QString::number(1.0));
    ui->lineEdit_lambda_1_left->setEnabled(true);
    ui->lineEdit_lambda_2_left->setText(QString::number(1.0));
    ui->lineEdit_lambda_2_left->setEnabled(true);
    ...
    ui->lineEdit_lambda_8_left->setText(QString::number(1.0));
    ui->lineEdit_lambda_8_left->setEnabled(true);
    ui->lineEdit_lambda_9_left->setText(QString::number(1.0));
    ui->lineEdit_lambda_9_left->setEnabled(true);
    ui->lineEdit_lambda_10_left->setText(QString::number(0.0));
    ui->lineEdit_lambda_10_left->setEnabled(false);
    ui->lineEdit_lambda_11_left->setText(QString::number(0.0));
    ui->lineEdit_lambda_11_left->setEnabled(false);

    //left Boundary Conditions
    //init vel
    ui->lineEdit_init_vel_1_left->setText(QString::number(0));
    ui->lineEdit_init_vel_1_left->setEnabled(true);
    ui->lineEdit_init_vel_2_left->setText(QString::number(0));
    ui->lineEdit_init_vel_2_left->setEnabled(true);
    ui->lineEdit_init_vel_3_left->setText(QString::number(0));
    ui->lineEdit_init_vel_3_left->setEnabled(true);
    ui->lineEdit_init_vel_4_left->setText(QString::number(0));
    ui->lineEdit_init_vel_4_left->setEnabled(true);
    ui->lineEdit_init_vel_5_left->setText(QString::number(0));
    ui->lineEdit_init_vel_5_left->setEnabled(true);
    ui->lineEdit_init_vel_6_left->setText(QString::number(0));
    ui->lineEdit_init_vel_6_left->setEnabled(true);
    ui->lineEdit_init_vel_7_left->setText(QString::number(0));
    ui->lineEdit_init_vel_7_left->setEnabled(true);
    ui->lineEdit_init_vel_8_left->setText(QString::number(0));
    ui->lineEdit_init_vel_8_left->setEnabled(true);
    ui->lineEdit_init_vel_9_left->setText(QString::number(0));
    ui->lineEdit_init_vel_9_left->setEnabled(true);
    ui->lineEdit_init_vel_10_left->setText(QString::number(0));
    ui->lineEdit_init_vel_10_left->setEnabled(false);
    ui->lineEdit_init_vel_11_left->setText(QString::number(0));
    ui->lineEdit_init_vel_11_left->setEnabled(false);
    //final vel
    ui->lineEdit_final_vel_1_left->setText(QString::number(0));
    ui->lineEdit_final_vel_1_left->setEnabled(true);
    ui->lineEdit_final_vel_2_left->setText(QString::number(0));
    ui->lineEdit_final_vel_2_left->setEnabled(true);
    ui->lineEdit_final_vel_3_left->setText(QString::number(0));
    ui->lineEdit_final_vel_3_left->setEnabled(true);
    ui->lineEdit_final_vel_4_left->setText(QString::number(0));
    ui->lineEdit_final_vel_4_left->setEnabled(true);
    ui->lineEdit_final_vel_5_left->setText(QString::number(0));
    ui->lineEdit_final_vel_5_left->setEnabled(true);
    ui->lineEdit_final_vel_6_left->setText(QString::number(0));
    ui->lineEdit_final_vel_6_left->setEnabled(true);
    ui->lineEdit_final_vel_7_left->setText(QString::number(0));
    ui->lineEdit_final_vel_7_left->setEnabled(true);
    ui->lineEdit_final_vel_8_left->setText(QString::number(0));
    ui->lineEdit_final_vel_8_left->setEnabled(true);
    ui->lineEdit_final_vel_9_left->setText(QString::number(0));
    ui->lineEdit_final_vel_9_left->setEnabled(true);
    ui->lineEdit_final_vel_10_left->setText(QString::number(0));
    ui->lineEdit_final_vel_10_left->setEnabled(false);
    ui->lineEdit_final_vel_11_left->setText(QString::number(0));
    ui->lineEdit_final_vel_11_left->setEnabled(false);
    //init acc
    ui->lineEdit_init_acc_1_left->setText(QString::number(0));
    ui->lineEdit_init_acc_1_left->setEnabled(true);
    ui->lineEdit_init_acc_2_left->setText(QString::number(0));
    ui->lineEdit_init_acc_2_left->setEnabled(true);
    ui->lineEdit_init_acc_3_left->setText(QString::number(0));
    ui->lineEdit_init_acc_3_left->setEnabled(true);
    ui->lineEdit_init_acc_4_left->setText(QString::number(0));
    ui->lineEdit_init_acc_4_left->setEnabled(true);
    ui->lineEdit_init_acc_5_left->setText(QString::number(0));
    ui->lineEdit_init_acc_5_left->setEnabled(true);
    ui->lineEdit_init_acc_6_left->setText(QString::number(0));
    ui->lineEdit_init_acc_6_left->setEnabled(true);
    ui->lineEdit_init_acc_7_left->setText(QString::number(0));
    ui->lineEdit_init_acc_7_left->setEnabled(true);
    ui->lineEdit_init_acc_8_left->setText(QString::number(0));
    ui->lineEdit_init_acc_8_left->setEnabled(true);
    ui->lineEdit_init_acc_9_left->setText(QString::number(0));
    ui->lineEdit_init_acc_9_left->setEnabled(true);
    ui->lineEdit_init_acc_10_left->setText(QString::number(0));
    ui->lineEdit_init_acc_10_left->setEnabled(false);
    ui->lineEdit_init_acc_11_left->setText(QString::number(0));
    ui->lineEdit_init_acc_11_left->setEnabled(false);
    //final acc
    ui->lineEdit_final_acc_1_left->setText(QString::number(0));
    ui->lineEdit_final_acc_1_left->setEnabled(true);
    ui->lineEdit_final_acc_2_left->setText(QString::number(0));
    ui->lineEdit_final_acc_2_left->setEnabled(true);
    ui->lineEdit_final_acc_3_left->setText(QString::number(0));
    ui->lineEdit_final_acc_3_left->setEnabled(true);
    ui->lineEdit_final_acc_4_left->setText(QString::number(0));
    ui->lineEdit_final_acc_4_left->setEnabled(true);
    ui->lineEdit_final_acc_5_left->setText(QString::number(0));
    ui->lineEdit_final_acc_5_left->setEnabled(true);
    ui->lineEdit_final_acc_6_left->setText(QString::number(0));
    ui->lineEdit_final_acc_6_left->setEnabled(true);
    ui->lineEdit_final_acc_7_left->setText(QString::number(0));
    ui->lineEdit_final_acc_7_left->setEnabled(true);
    ui->lineEdit_final_acc_8_left->setText(QString::number(0));
    ui->lineEdit_final_acc_8_left->setEnabled(true);
    ui->lineEdit_final_acc_9_left->setText(QString::number(0));
    ui->lineEdit_final_acc_9_left->setEnabled(true);
    ui->lineEdit_final_acc_10_left->setText(QString::number(0));
    ui->lineEdit_final_acc_10_left->setEnabled(false);
    ui->lineEdit_final_acc_11_left->setText(QString::number(0));
    ui->lineEdit_final_acc_11_left->setEnabled(false);
    ...
    //Final Hand Posture
    ui->lineEdit_final_hand_1_left->setText(QString::number(0));
    ui->lineEdit_final_hand_1_left->setEnabled(true);
    ui->lineEdit_final_hand_2_left->setText(QString::number(0));
    ui->lineEdit_final_hand_2_left->setEnabled(true);
    ui->lineEdit_final_hand_3_left->setText(QString::number(0));
    ui->lineEdit_final_hand_3_left->setEnabled(false);
    ui->lineEdit_final_hand_4_left->setText(QString::number(0));
    ui->lineEdit_final_hand_4_left->setEnabled(false);
...
#if HAND != 0 && HAND != 1
void TolDialogHUMPDual::setTypeHands(int typeRightHand, int typeLeftHand){
    if(typeRightHand == 2){
        ui->checkBox_EG_right->setEnabled(true);
        ui->checkBox_QbSoftHand_right->setEnabled(true);

        ui->checkBox_EG_right->setChecked(true);
        ui->checkBox_QbSoftHand_right->setChecked(false);

        adaptationRightElectricGripper();
    }else if(typeRightHand == 3){
        ui->checkBox_EG_right->setEnabled(true);
        ui->checkBox_QbSoftHand_right->setEnabled(true);

        ui->checkBox_EG_right->setChecked(false);
        ui->checkBox_QbSoftHand_right->setChecked(true);

        adaptationRightQbSoftHand();
    }

    if(typeLeftHand == 2){
        ui->checkBox_EG_left->setEnabled(true);
        ui->checkBox_QbSoftHand_left->setEnabled(true);

        ui->checkBox_EG_left->setChecked(true);
        ui->checkBox_QbSoftHand_left->setChecked(false);

        adaptationLeftElectricGripper();
    }else if(typeLeftHand == 3){
        ui->checkBox_EG_left->setEnabled(true);
        ui->checkBox_QbSoftHand_left->setEnabled(true);

        ui->checkBox_EG_left->setChecked(false);
        ui->checkBox_QbSoftHand_left->setChecked(true);
        adaptationLeftQbSoftHand();
    }
}
#endif
...
void TolDialogHUMPDual::getTolsHandRight(MatrixXd &tols)
{
        ...
        tols(0,0) = ui->lineEdit_hand_1_1_right->text().toDouble();
        tols(0,1) = ui->lineEdit_hand_1_2_right->text().toDouble();
        tols(0,2) = ui->lineEdit_hand_1_3_right->text().toDouble();
        tols(1,0) = ui->lineEdit_hand_2_1_right->text().toDouble();
        tols(1,1) = ui->lineEdit_hand_2_2_right->text().toDouble();
        tols(1,2) = ui->lineEdit_hand_2_3_right->text().toDouble();
        tols(2,0) = ui->lineEdit_hand_3_1_right->text().toDouble();
        tols(2,1) = ui->lineEdit_hand_3_2_right->text().toDouble();
        tols(2,2) = ui->lineEdit_hand_3_3_right->text().toDouble();
        tols(3,0) = ui->lineEdit_hand_tip_1_right->text().toDouble();
        tols(3,1) = ui->lineEdit_hand_tip_2_right->text().toDouble();
        tols(3,2) = ui->lineEdit_hand_tip_3_right->text().toDouble();
    #else
        if(ui->checkBox_EG_right->isChecked() && !(ui->checkBox_QbSoftHand_right->isChecked())){
            tols = MatrixXd::Constant(4,3,1);

            tols(0,0) = ui->lineEdit_hand_EG_1_1_right->text().toDouble();
            tols(0,1) = ui->lineEdit_hand_EG_1_2_right->text().toDouble();
            tols(0,2) = ui->lineEdit_hand_EG_1_3_right->text().toDouble();
            tols(1,0) = ui->lineEdit_hand_EG_2_1_right->text().toDouble();
            tols(1,1) = ui->lineEdit_hand_EG_2_2_right->text().toDouble();
            tols(1,2) = ui->lineEdit_hand_EG_2_3_right->text().toDouble();
            tols(2,0) = ui->lineEdit_hand_EG_3_1_right->text().toDouble();
            tols(2,1) = ui->lineEdit_hand_EG_3_2_right->text().toDouble();
            tols(2,2) = ui->lineEdit_hand_EG_3_3_right->text().toDouble();
            tols(3,0) = ui->lineEdit_hand_EG_tip_1_right->text().toDouble();
            tols(3,1) = ui->lineEdit_hand_EG_tip_2_right->text().toDouble();
            tols(3,2) = ui->lineEdit_hand_EG_tip_3_right->text().toDouble();
        }else if(ui->checkBox_QbSoftHand_right->isChecked() && !(ui->checkBox_EG_right->isChecked())){
            tols = MatrixXd::Constant(5,5,1);

            // Thumb
            tols(0,0) = ui->lineEdit_hand_Qb_1_1_right->text().toDouble();
            tols(0,1) = ui->lineEdit_hand_Qb_2_1_right->text().toDouble();
            tols(0,2) = ui->lineEdit_hand_Qb_3_1_right->text().toDouble();
            tols(0,3) = ui->lineEdit_hand_Qb_4_1_right->text().toDouble();
            tols(0,4) = ui->lineEdit_hand_Qb_tip_1_right->text().toDouble();

            //Index
            tols(1,0) = ui->lineEdit_hand_Qb_1_2_right->text().toDouble();
            tols(1,1) = ui->lineEdit_hand_Qb_2_2_right->text().toDouble();
            tols(1,2) = ui->lineEdit_hand_Qb_3_2_right->text().toDouble();
            tols(1,3) = ui->lineEdit_hand_Qb_4_2_right->text().toDouble();
            tols(1,4) = ui->lineEdit_hand_Qb_tip_2_right->text().toDouble();

            //Middle
            tols(2,0) = ui->lineEdit_hand_Qb_1_3_right->text().toDouble();
            tols(2,1) = ui->lineEdit_hand_Qb_2_3_right->text().toDouble();
            tols(2,2) = ui->lineEdit_hand_Qb_3_3_right->text().toDouble();
            tols(2,3) = ui->lineEdit_hand_Qb_4_3_right->text().toDouble();
            tols(2,4) = ui->lineEdit_hand_Qb_tip_3_right->text().toDouble();

            //Ring
            tols(3,0) = ui->lineEdit_hand_Qb_1_4_right->text().toDouble();
            tols(3,1) = ui->lineEdit_hand_Qb_2_4_right->text().toDouble();
            tols(3,2) = ui->lineEdit_hand_Qb_3_4_right->text().toDouble();
            tols(3,3) = ui->lineEdit_hand_Qb_4_4_right->text().toDouble();
            tols(3,4) = ui->lineEdit_hand_Qb_tip_4_right->text().toDouble();

            //Little
            tols(0,0) = ui->lineEdit_hand_Qb_1_5_right->text().toDouble();
            tols(0,1) = ui->lineEdit_hand_Qb_2_5_right->text().toDouble();
            tols(0,2) = ui->lineEdit_hand_Qb_3_5_right->text().toDouble();
            tols(0,3) = ui->lineEdit_hand_Qb_4_5_right->text().toDouble();
            tols(0,4) = ui->lineEdit_hand_Qb_tip_5_right->text().toDouble();
        }
    #endif
}
...
void TolDialogHUMPDual::getTolsHandLeft(MatrixXd &tols)
{
        ...
        tols(0,0) = ui->lineEdit_hand_1_1_left->text().toDouble();
        tols(0,1) = ui->lineEdit_hand_1_2_left->text().toDouble();
        tols(0,2) = ui->lineEdit_hand_1_3_left->text().toDouble();
        tols(1,0) = ui->lineEdit_hand_2_1_left->text().toDouble();
        tols(1,1) = ui->lineEdit_hand_2_2_left->text().toDouble();
        tols(1,2) = ui->lineEdit_hand_2_3_left->text().toDouble();
        tols(2,0) = ui->lineEdit_hand_3_1_left->text().toDouble();
        tols(2,1) = ui->lineEdit_hand_3_2_left->text().toDouble();
        tols(2,2) = ui->lineEdit_hand_3_3_left->text().toDouble();
        tols(3,0) = ui->lineEdit_hand_tip_1_left->text().toDouble();
        tols(3,1) = ui->lineEdit_hand_tip_2_left->text().toDouble();
        tols(3,2) = ui->lineEdit_hand_tip_3_left->text().toDouble();
    #else
    if(ui->checkBox_EG_left->isChecked() && !(ui->checkBox_QbSoftHand_left->isChecked())){
        tols = MatrixXd::Constant(4,3,1);

        tols(0,0) = ui->lineEdit_hand_EG_1_1_left->text().toDouble();
        tols(0,1) = ui->lineEdit_hand_EG_1_2_left->text().toDouble();
        tols(0,2) = ui->lineEdit_hand_EG_1_3_left->text().toDouble();
        tols(1,0) = ui->lineEdit_hand_EG_2_1_left->text().toDouble();
        tols(1,1) = ui->lineEdit_hand_EG_2_2_left->text().toDouble();
        tols(1,2) = ui->lineEdit_hand_EG_2_3_left->text().toDouble();
        tols(2,0) = ui->lineEdit_hand_EG_3_1_left->text().toDouble();
        tols(2,1) = ui->lineEdit_hand_EG_3_2_left->text().toDouble();
        tols(2,2) = ui->lineEdit_hand_EG_3_3_left->text().toDouble();
        tols(3,0) = ui->lineEdit_hand_EG_tip_1_left->text().toDouble();
        tols(3,1) = ui->lineEdit_hand_EG_tip_2_left->text().toDouble();
        tols(3,2) = ui->lineEdit_hand_EG_tip_3_left->text().toDouble();
    }else if(ui->checkBox_QbSoftHand_left->isChecked() && !(ui->checkBox_EG_left->isChecked())){
        tols = MatrixXd::Constant(5,5,1);

        // Thumb
        tols(0,0) = ui->lineEdit_hand_Qb_1_1_left->text().toDouble();
        tols(0,1) = ui->lineEdit_hand_Qb_2_1_left->text().toDouble();
        tols(0,2) = ui->lineEdit_hand_Qb_3_1_left->text().toDouble();
        tols(0,3) = ui->lineEdit_hand_Qb_4_1_left->text().toDouble();
        tols(0,4) = ui->lineEdit_hand_Qb_tip_1_left->text().toDouble();

        //Index
        tols(1,0) = ui->lineEdit_hand_Qb_1_2_left->text().toDouble();
        tols(1,1) = ui->lineEdit_hand_Qb_2_2_left->text().toDouble();
        tols(1,2) = ui->lineEdit_hand_Qb_3_2_left->text().toDouble();
        tols(1,3) = ui->lineEdit_hand_Qb_4_2_left->text().toDouble();
        tols(1,4) = ui->lineEdit_hand_Qb_tip_2_left->text().toDouble();

        //Middle
        tols(2,0) = ui->lineEdit_hand_Qb_1_3_left->text().toDouble();
        tols(2,1) = ui->lineEdit_hand_Qb_2_3_left->text().toDouble();
        tols(2,2) = ui->lineEdit_hand_Qb_3_3_left->text().toDouble();
        tols(2,3) = ui->lineEdit_hand_Qb_4_3_left->text().toDouble();
        tols(2,4) = ui->lineEdit_hand_Qb_tip_3_left->text().toDouble();

        //Ring
        tols(3,0) = ui->lineEdit_hand_Qb_1_4_left->text().toDouble();
        tols(3,1) = ui->lineEdit_hand_Qb_2_4_left->text().toDouble();
        tols(3,2) = ui->lineEdit_hand_Qb_3_4_left->text().toDouble();
        tols(3,3) = ui->lineEdit_hand_Qb_4_4_left->text().toDouble();
        tols(3,4) = ui->lineEdit_hand_Qb_tip_4_left->text().toDouble();

        //Little
        tols(0,0) = ui->lineEdit_hand_Qb_1_5_left->text().toDouble();
        tols(0,1) = ui->lineEdit_hand_Qb_2_5_left->text().toDouble();
        tols(0,2) = ui->lineEdit_hand_Qb_3_5_left->text().toDouble();
        tols(0,3) = ui->lineEdit_hand_Qb_4_5_left->text().toDouble();
        tols(0,4) = ui->lineEdit_hand_Qb_tip_5_left->text().toDouble();
    }
...
void TolDialogHUMPDual::getLambdaRight(std::vector<double> &lambda)
{
    ...
    #else
        if(ui->checkBox_QbSoftHand_right->isChecked() && !(ui->checkBox_EG_right->isChecked()))
            lambda.push_back(ui->lineEdit_lambda_9_right->text().toDouble());
    #endif
...
void TolDialogHUMPDual::getTolsObstaclesRight(MatrixXd &tols)
{
    ...
    tols(0,0)=ui->lineEdit_obs_xx_1_right->text().toDouble(); 
    tols(0,1)=ui->lineEdit_obs_yy_1_right->text().toDouble(); 
    tols(0,2)=ui->lineEdit_obs_zz_1_right->text().toDouble(); 
    tols(0,3)=ui->lineEdit_obs_xy_1_right->text().toDouble(); 
    tols(0,4)=ui->lineEdit_obs_xz_1_right->text().toDouble(); 
    tols(0,5)=ui->lineEdit_obs_yz_1_right->text().toDouble();
    tols(1,0)=ui->lineEdit_obs_xx_2_right->text().toDouble(); 
    tols(1,1)=ui->lineEdit_obs_yy_2_right->text().toDouble(); 
    tols(1,2)=ui->lineEdit_obs_zz_2_right->text().toDouble(); 
    tols(1,3)=ui->lineEdit_obs_xy_2_right->text().toDouble(); 
    tols(1,4)=ui->lineEdit_obs_xz_2_right->text().toDouble(); 
    tols(1,5)=ui->lineEdit_obs_yz_2_right->text().toDouble();
    tols(2,0)=ui->lineEdit_obs_xx_3_right->text().toDouble(); 
    tols(2,1)=ui->lineEdit_obs_yy_3_right->text().toDouble(); 
    tols(2,2)=ui->lineEdit_obs_zz_3_right->text().toDouble(); 
    tols(2,3)=ui->lineEdit_obs_xy_3_right->text().toDouble(); 
    tols(2,4)=ui->lineEdit_obs_xz_3_right->text().toDouble(); 
    tols(2,5)=ui->lineEdit_obs_yz_3_right->text().toDouble();
...
void TolDialogHUMPDual::getTolsObstaclesLeft(MatrixXd &tols)
{
    ...
    tols(0,0)=ui->lineEdit_obs_xx_1_left->text().toDouble(); 
    tols(0,1)=ui->lineEdit_obs_yy_1_left->text().toDouble(); 
    tols(0,2)=ui->lineEdit_obs_zz_1_left->text().toDouble(); 
    tols(0,3)=ui->lineEdit_obs_xy_1_left->text().toDouble(); 
    tols(0,4)=ui->lineEdit_obs_xz_1_left->text().toDouble(); 
    tols(0,5)=ui->lineEdit_obs_yz_1_left->text().toDouble();
    tols(1,0)=ui->lineEdit_obs_xx_2_left->text().toDouble(); 
    tols(1,1)=ui->lineEdit_obs_yy_2_left->text().toDouble(); 
    tols(1,2)=ui->lineEdit_obs_zz_2_left->text().toDouble(); 
    tols(1,3)=ui->lineEdit_obs_xy_2_left->text().toDouble(); 
    tols(1,4)=ui->lineEdit_obs_xz_2_left->text().toDouble(); 
    tols(1,5)=ui->lineEdit_obs_yz_2_left->text().toDouble();
    tols(2,0)=ui->lineEdit_obs_xx_3_left->text().toDouble(); 
    tols(2,1)=ui->lineEdit_obs_yy_3_left->text().toDouble(); 
    tols(2,2)=ui->lineEdit_obs_zz_3_left->text().toDouble(); 
    tols(2,3)=ui->lineEdit_obs_xy_3_left->text().toDouble(); 
    tols(2,4)=ui->lineEdit_obs_xz_3_left->text().toDouble(); 
    tols(2,5)=ui->lineEdit_obs_yz_3_left->text().toDouble();
...
void TolDialogHUMPDual::getTolsTargetRight(MatrixXd &tols)
{
    ...
    tols(0,0)=ui->lineEdit_tar_xx_1_right->text().toDouble(); 
    tols(0,1)=ui->lineEdit_tar_yy_1_right->text().toDouble(); 
    tols(0,2)=ui->lineEdit_tar_zz_1_right->text().toDouble(); 
    tols(0,3)=ui->lineEdit_tar_xy_1_right->text().toDouble(); 
    tols(0,4)=ui->lineEdit_tar_xz_1_right->text().toDouble(); 
    tols(0,5)=ui->lineEdit_tar_yz_1_right->text().toDouble();
    tols(1,0)=ui->lineEdit_tar_xx_2_right->text().toDouble(); 
    tols(1,1)=ui->lineEdit_tar_yy_2_right->text().toDouble(); 
    tols(1,2)=ui->lineEdit_tar_zz_2_right->text().toDouble(); 
    tols(1,3)=ui->lineEdit_tar_xy_2_right->text().toDouble(); 
    tols(1,4)=ui->lineEdit_tar_xz_2_right->text().toDouble(); 
    tols(1,5)=ui->lineEdit_tar_yz_2_right->text().toDouble();
    tols(2,0)=ui->lineEdit_tar_xx_3_right->text().toDouble(); 
    tols(2,1)=ui->lineEdit_tar_yy_3_right->text().toDouble(); 
    tols(2,2)=ui->lineEdit_tar_zz_3_right->text().toDouble(); 
    tols(2,3)=ui->lineEdit_tar_xy_3_right->text().toDouble(); 
    tols(2,4)=ui->lineEdit_tar_xz_3_right->text().toDouble(); 
    tols(2,5)=ui->lineEdit_tar_yz_3_right->text().toDouble();
...
void TolDialogHUMPDual::getTolsTargetLeft(MatrixXd &tols)
{
    ...
    tols(0,0)=ui->lineEdit_tar_xx_1_left->text().toDouble(); 
    tols(0,1)=ui->lineEdit_tar_yy_1_left->text().toDouble(); 
    tols(0,2)=ui->lineEdit_tar_zz_1_left->text().toDouble(); 
    tols(0,3)=ui->lineEdit_tar_xy_1_left->text().toDouble(); 
    tols(0,4)=ui->lineEdit_tar_xz_1_left->text().toDouble(); 
    tols(0,5)=ui->lineEdit_tar_yz_1_left->text().toDouble();
    tols(1,0)=ui->lineEdit_tar_xx_2_left->text().toDouble(); 
    tols(1,1)=ui->lineEdit_tar_yy_2_left->text().toDouble(); 
    tols(1,2)=ui->lineEdit_tar_zz_2_left->text().toDouble(); 
    tols(1,3)=ui->lineEdit_tar_xy_2_left->text().toDouble(); 
    tols(1,4)=ui->lineEdit_tar_xz_2_left->text().toDouble(); 
    tols(1,5)=ui->lineEdit_tar_yz_2_left->text().toDouble();
    tols(2,0)=ui->lineEdit_tar_xx_3_left->text().toDouble(); 
    tols(2,1)=ui->lineEdit_tar_yy_3_left->text().toDouble(); 
    tols(2,2)=ui->lineEdit_tar_zz_3_left->text().toDouble(); 
    tols(2,3)=ui->lineEdit_tar_xy_3_left->text().toDouble(); 
    tols(2,4)=ui->lineEdit_tar_xz_3_left->text().toDouble(); 
    tols(2,5)=ui->lineEdit_tar_yz_3_left->text().toDouble();
...
#if HAND != 0 && HAND != 1
double TolDialogHUMPDual::getWMaxGripper()
{
    return ui->lineEdit_w_max_gripper->text().toDouble();
}

double TolDialogHUMPDual::getAlphaMaxGripper()
{
    return ui->lineEdit_alpha_max_gripper->text().toDouble();
}

void TolDialogHUMPDual::setWMaxGripper(double w)
{
   ui->lineEdit_w_max_gripper->setText(QString::number(w));
}

double TolDialogHUMPDual::getWMaxSoftHand()
{
    return ui->lineEdit_w_max_SoftHand->text().toDouble();
}

double TolDialogHUMPDual::getAlphaMaxSoftHand()
{
    return ui->lineEdit_alpha_max_SoftHand->text().toDouble();
}

void TolDialogHUMPDual::setWMaxSoftHand(double w)
{
    ui->lineEdit_w_max_SoftHand->setText(QString::number(w));
}
#endif
...
void TolDialogHUMPDual::getInitVelLeft(std::vector<double> &init_vel)
{
    ...
    #else
        if(ui->checkBox_QbSoftHand_left->isChecked() && !(ui->checkBox_EG_left->isChecked()))
            init_vel.push_back(ui->lineEdit_init_vel_9_left->text().toDouble());
    #endif
}
...
bool TolDialogHUMPDual::getRetreatFinalValuesRight_Info(){
    return ui->Retreat_Final_Values_right_2->isChecked();
}

bool TolDialogHUMPDual::getRetreatFinalValuesLeft_Info(){
    return ui->Retreat_Final_Values_left->isChecked();
}
...
void TolDialogHUMPDual::on_pushButton_save_clicked()
{
   ...
   if(f.open( QIODevice::WriteOnly )){
       ...
       #else
           if(ui->checkBox_EG_right->isChecked() && !(ui->checkBox_QbSoftHand_right->isChecked())){
               stream << "Hand_EG_1_1_right=" << ui->lineEdit_hand_EG_1_1_right->text().toStdString().c_str() << endl;
               stream << "Hand_EG_1_2_right=" << ui->lineEdit_hand_EG_1_2_right->text().toStdString().c_str() << endl;
               stream << "Hand_EG_1_3_right=" << ui->lineEdit_hand_EG_1_3_right->text().toStdString().c_str() << endl;
               stream << "Hand_EG_2_1_right=" << ui->lineEdit_hand_EG_2_1_right->text().toStdString().c_str() << endl;
               stream << "Hand_EG_2_2_right=" << ui->lineEdit_hand_EG_2_2_right->text().toStdString().c_str() << endl;
               stream << "Hand_EG_2_3_right=" << ui->lineEdit_hand_EG_2_3_right->text().toStdString().c_str() << endl;
               stream << "Hand_EG_3_1_right=" << ui->lineEdit_hand_EG_3_1_right->text().toStdString().c_str() << endl;
               stream << "Hand_EG_3_2_right=" << ui->lineEdit_hand_EG_3_2_right->text().toStdString().c_str() << endl;
               stream << "Hand_EG_3_3_right=" << ui->lineEdit_hand_EG_3_3_right->text().toStdString().c_str() << endl;
               stream << "Hand_EG_tip_1_right=" << ui->lineEdit_hand_EG_tip_1_right->text().toStdString().c_str() << endl;
               stream << "Hand_EG_tip_2_right=" << ui->lineEdit_hand_EG_tip_2_right->text().toStdString().c_str() << endl;
           }else if(ui->checkBox_QbSoftHand_right->isChecked() && !(ui->checkBox_EG_right->isChecked())){
               stream << "Hand_Qb_1_1_right=" << ui->lineEdit_hand_Qb_1_1_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_1_2_right=" << ui->lineEdit_hand_Qb_1_2_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_1_3_right=" << ui->lineEdit_hand_Qb_1_3_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_1_4_right=" << ui->lineEdit_hand_Qb_1_4_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_1_5_right=" << ui->lineEdit_hand_Qb_1_5_right->text().toStdString().c_str() << endl;

               stream << "Hand_Qb_2_1_right=" << ui->lineEdit_hand_Qb_2_1_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_2_2_right=" << ui->lineEdit_hand_Qb_2_2_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_2_3_right=" << ui->lineEdit_hand_Qb_2_3_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_2_4_right=" << ui->lineEdit_hand_Qb_2_4_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_2_5_right=" << ui->lineEdit_hand_Qb_2_5_right->text().toStdString().c_str() << endl;

               stream << "Hand_Qb_3_1_right=" << ui->lineEdit_hand_Qb_3_1_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_3_2_right=" << ui->lineEdit_hand_Qb_3_2_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_3_3_right=" << ui->lineEdit_hand_Qb_3_3_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_3_4_right=" << ui->lineEdit_hand_Qb_3_4_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_3_5_right=" << ui->lineEdit_hand_Qb_3_5_right->text().toStdString().c_str() << endl;

               stream << "Hand_Qb_4_1_right=" << ui->lineEdit_hand_Qb_4_1_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_4_2_right=" << ui->lineEdit_hand_Qb_4_2_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_4_3_right=" << ui->lineEdit_hand_Qb_4_3_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_4_4_right=" << ui->lineEdit_hand_Qb_4_4_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_4_5_right=" << ui->lineEdit_hand_Qb_4_5_right->text().toStdString().c_str() << endl;

               stream << "Hand_Qb_tip_1_right=" << ui->lineEdit_hand_Qb_tip_1_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_tip_2_right=" << ui->lineEdit_hand_Qb_tip_2_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_tip_3_right=" << ui->lineEdit_hand_Qb_tip_3_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_tip_4_right=" << ui->lineEdit_hand_Qb_tip_4_right->text().toStdString().c_str() << endl;
               stream << "Hand_Qb_tip_5_right=" << ui->lineEdit_hand_Qb_tip_5_right->text().toStdString().c_str() << endl;
           }
       #endif
       ...
       stream << "Hand_radius_left=" << ui->lineEdit_hand_r_left->text().toStdString().c_str() << endl;
        ...
        #else
            if(ui->checkBox_EG_left->isChecked() && !(ui->checkBox_QbSoftHand_left->isChecked())){
                stream << "Hand_EG_1_1_left=" << ui->lineEdit_hand_EG_1_1_left->text().toStdString().c_str() << endl;
                stream << "Hand_EG_1_2_left=" << ui->lineEdit_hand_EG_1_2_left->text().toStdString().c_str() << endl;
                stream << "Hand_EG_1_3_left=" << ui->lineEdit_hand_EG_1_3_left->text().toStdString().c_str() << endl;
                stream << "Hand_EG_2_1_left=" << ui->lineEdit_hand_EG_2_1_left->text().toStdString().c_str() << endl;
                stream << "Hand_EG_2_2_left=" << ui->lineEdit_hand_EG_2_2_left->text().toStdString().c_str() << endl;
                stream << "Hand_EG_2_3_left=" << ui->lineEdit_hand_EG_2_3_left->text().toStdString().c_str() << endl;
                stream << "Hand_EG_3_1_left=" << ui->lineEdit_hand_EG_3_1_left->text().toStdString().c_str() << endl;
                stream << "Hand_EG_3_2_left=" << ui->lineEdit_hand_EG_3_2_left->text().toStdString().c_str() << endl;
                stream << "Hand_EG_3_3_left=" << ui->lineEdit_hand_EG_3_3_left->text().toStdString().c_str() << endl;
                stream << "Hand_EG_tip_1_left=" << ui->lineEdit_hand_EG_tip_1_left->text().toStdString().c_str() << endl;
                stream << "Hand_EG_tip_2_left=" << ui->lineEdit_hand_EG_tip_2_left->text().toStdString().c_str() << endl;
            }else if(ui->checkBox_QbSoftHand_left->isChecked() && !(ui->checkBox_EG_left->isChecked())){
                stream << "Hand_Qb_1_1_left=" << ui->lineEdit_hand_Qb_1_1_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_1_2_left=" << ui->lineEdit_hand_Qb_1_2_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_1_3_left=" << ui->lineEdit_hand_Qb_1_3_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_1_4_left=" << ui->lineEdit_hand_Qb_1_4_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_1_5_left=" << ui->lineEdit_hand_Qb_1_5_left->text().toStdString().c_str() << endl;

                stream << "Hand_Qb_2_1_left=" << ui->lineEdit_hand_Qb_2_1_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_2_2_left=" << ui->lineEdit_hand_Qb_2_2_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_2_3_left=" << ui->lineEdit_hand_Qb_2_3_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_2_4_left=" << ui->lineEdit_hand_Qb_2_4_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_2_5_left=" << ui->lineEdit_hand_Qb_2_5_left->text().toStdString().c_str() << endl;

                stream << "Hand_Qb_3_1_left=" << ui->lineEdit_hand_Qb_3_1_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_3_2_left=" << ui->lineEdit_hand_Qb_3_2_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_3_3_left=" << ui->lineEdit_hand_Qb_3_3_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_3_4_left=" << ui->lineEdit_hand_Qb_3_4_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_3_5_left=" << ui->lineEdit_hand_Qb_3_5_left->text().toStdString().c_str() << endl;

                stream << "Hand_Qb_4_1_left=" << ui->lineEdit_hand_Qb_4_1_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_4_2_left=" << ui->lineEdit_hand_Qb_4_2_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_4_3_left=" << ui->lineEdit_hand_Qb_4_3_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_4_4_left=" << ui->lineEdit_hand_Qb_4_4_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_4_5_left=" << ui->lineEdit_hand_Qb_4_5_left->text().toStdString().c_str() << endl;

                stream << "Hand_Qb_tip_1_left=" << ui->lineEdit_hand_Qb_tip_1_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_tip_2_left=" << ui->lineEdit_hand_Qb_tip_2_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_tip_3_left=" << ui->lineEdit_hand_Qb_tip_3_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_tip_4_left=" << ui->lineEdit_hand_Qb_tip_4_left->text().toStdString().c_str() << endl;
                stream << "Hand_Qb_tip_5_left=" << ui->lineEdit_hand_Qb_tip_5_left->text().toStdString().c_str() << endl;
            }
        #endif
       ...
       if (ui->Retreat_Final_Values_right_2->isChecked()){ stream << "Retreat_Final_Values_right=true"<< endl;}else{stream << "Retreat_Final_Values_right=false"<< endl;}
       if (ui->Retreat_Final_Values_left->isChecked()){ stream << "Retreat_Final_Values_left=true"<< endl;}else{stream << "Retreat_Final_Values_left=false"<< endl;}
       ...
       stream << "grasp_offset_right=" << ui->lineEdit_grasp_offset_right->text().toStdString().c_str() << endl;
       ...
       stream << "grasp_offset_left=" << ui->lineEdit_grasp_offset_left->text().toStdString().c_str() << endl;
       ...
       stream << "max_acceleration="<< ui->lineEdit_alpha_max->text().toStdString().c_str() <<endl;
        #if HAND != 0 && HAND != 1
            if(ui->checkBox_EG_right->isChecked() || ui->checkBox_EG_left->isChecked()){
            ...
            }else if(ui->checkBox_QbSoftHand_right->isChecked() || ui->checkBox_QbSoftHand_left->isChecked()){
                stream << "max_velocity_hand="<< ui->lineEdit_w_max_SoftHand->text().toStdString().c_str() <<endl;
                stream << "max_alpha_hand="<< ui->lineEdit_alpha_max_SoftHand->text().toStdString().c_str() <<endl;
            }
        #endif
       ...
       if(ui->checkBox_EG_right->isChecked()){stream << "set_Electric_Gripper_right=true" << endl;}else{stream <<"set_Electric_Gripper_right=false" << endl;}
       if(ui->checkBox_QbSoftHand_right->isChecked()){stream << "set_QbSoftHand_right=true" << endl;}else{stream <<"set_QbSoftHand_right=false" << endl;}
       if(ui->checkBox_EG_left->isChecked()){stream << "set_Electric_Gripper_left=true" << endl;}else{stream <<"set_Electric_Gripper_left=false" << endl;}
       if(ui->checkBox_QbSoftHand_left->isChecked()){stream << "set_QbSoftHand_left=true" << endl;}else{stream <<"set_QbSoftHand_left=false" << endl;}
    ...
    if(f.open( QIODevice::ReadOnly )){
        ...
        while(!stream.atEnd()){
            ...
            if(line.at(0)!=QChar('#')){
                ...
                #if HAND == 0 || HAND == 1
                    if(QString::compare(fields.at(0),QString("Hand_1_1_right"),Qt::CaseInsensitive)==0)
                ...
                #else
                    if(ui->checkBox_EG_right->isChecked() && !(ui->checkBox_QbSoftHand_right->isChecked())){
                        if(QString::compare(fields.at(0),QString("Hand_EG_1_1_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_EG_1_1_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_1_2_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_EG_1_2_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_1_3_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_EG_1_3_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_2_1_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_EG_2_1_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_2_2_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_EG_2_2_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_2_3_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_EG_2_3_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_3_1_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_EG_3_1_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_3_2_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_EG_3_2_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_3_3_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_EG_3_3_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_tip_1_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_EG_tip_1_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_tip_2_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_EG_tip_2_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_tip_3_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_EG_tip_3_right->setText(fields.at(1));
                    }else if(ui->checkBox_QbSoftHand_right->isChecked() && !(ui->checkBox_EG_right->isChecked())){
                        if(QString::compare(fields.at(0),QString("Hand_Qb_1_1_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_Qb_1_1_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_1_2_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_Qb_1_2_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_1_3_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_1_3_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_1_4_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_1_4_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_1_5_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_1_5_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_2_1_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_2_1_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_2_2_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_2_2_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_2_3_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_2_3_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_2_4_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_2_4_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_2_5_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_2_5_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_3_1_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_3_1_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_3_2_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_3_2_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_3_3_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_3_3_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_3_4_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_3_4_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_3_5_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_3_5_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_4_1_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_4_1_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_4_2_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_4_2_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_4_3_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_4_3_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_4_4_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_4_4_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_4_5_right"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_4_5_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_tip_1_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_Qb_tip_1_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_tip_2_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_Qb_tip_2_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_tip_3_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_Qb_tip_3_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_tip_4_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_Qb_tip_4_right->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_tip_5_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_Qb_tip_5_right->setText(fields.at(1));
                    }
                #endif
                if(QString::compare(fields.at(0),QString("Shoulder_radius_left"),Qt::CaseInsensitive)==0)
                ...
                #if HAND == 0 || HAND == 1
                    if(QString::compare(fields.at(0),QString("Hand_1_1_left"),Qt::CaseInsensitive)==0)
                ...
                #else
                    if(ui->checkBox_EG_left->isChecked() && !(ui->checkBox_QbSoftHand_left->isChecked())){
                        if(QString::compare(fields.at(0),QString("Hand_EG_1_1_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_EG_1_1_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_1_2_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_EG_1_2_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_1_3_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_EG_1_3_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_2_1_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_EG_2_1_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_2_2_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_EG_2_2_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_2_3_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_EG_2_3_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_3_1_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_EG_3_1_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_3_2_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_EG_3_2_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_3_3_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_EG_3_3_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_tip_1_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_EG_tip_1_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_tip_2_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_EG_tip_2_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_EG_tip_3_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_EG_tip_3_left->setText(fields.at(1));
                    }else if(ui->checkBox_QbSoftHand_left->isChecked() && !(ui->checkBox_EG_left->isChecked())){
                        if(QString::compare(fields.at(0),QString("Hand_Qb_1_1_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_Qb_1_1_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_1_2_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_Qb_1_2_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_1_3_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_1_3_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_1_4_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_1_4_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_1_5_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_1_5_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_2_1_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_2_1_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_2_2_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_2_2_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_2_3_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_2_3_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_2_4_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_2_4_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_2_5_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_2_5_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_3_1_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_3_1_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_3_2_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_3_2_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_3_3_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_3_3_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_3_4_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_3_4_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_3_5_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_3_5_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_4_1_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_4_1_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_4_2_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_4_2_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_4_3_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_4_3_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_4_4_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_4_4_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_4_5_left"),Qt::CaseInsensitive)==0)
                          ui->lineEdit_hand_Qb_4_5_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_tip_1_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_Qb_tip_1_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_tip_2_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_Qb_tip_2_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_tip_3_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_Qb_tip_3_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_tip_4_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_Qb_tip_4_left->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("Hand_Qb_tip_5_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_hand_Qb_tip_5_left->setText(fields.at(1));
                    }
                #endif
                if(QString::compare(fields.at(0),QString("lambda_1_right"),Qt::CaseInsensitive)==0)
                ...
                #if HAND == 0 || HAND == 1
                  if(QString::compare(fields.at(0),QString("lambda_10_right"),Qt::CaseInsensitive)==0)
                ...
                #else
                    if(ui->checkBox_QbSoftHand_right->isChecked() && !(ui->checkBox_EG_right->isChecked())){
                        if(QString::compare(fields.at(0),QString("lambda_9_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_lambda_9_right->setText(fields.at(1));
                    }
                #endif
                if(QString::compare(fields.at(0),QString("lambda_1_left"),Qt::CaseInsensitive)==0)
                ...
                #if HAND == 0 || HAND == 1
                  if(QString::compare(fields.at(0),QString("lambda_10_left"),Qt::CaseInsensitive)==0)
                ...
                #else
                    if(ui->checkBox_QbSoftHand_left->isChecked() && !(ui->checkBox_EG_left->isChecked())){
                        if(QString::compare(fields.at(0),QString("lambda_9_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_lambda_9_left->setText(fields.at(1));
                    }
                #endif
                if(QString::compare(fields.at(0),QString("init_vel_1_right"),Qt::CaseInsensitive)==0)
                ...
                #if HAND == 0 || HAND == 1
                    if(QString::compare(fields.at(0),QString("init_vel_10_right"),Qt::CaseInsensitive)==0)
                ...
                #else
                    if(ui->checkBox_QbSoftHand_right->isChecked() && !(ui->checkBox_EG_right->isChecked())){
                        if(QString::compare(fields.at(0),QString("init_vel_9_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_init_vel_9_right->setText(fields.at(1));
                    }
                #endif
                if(QString::compare(fields.at(0),QString("init_vel_1_left"),Qt::CaseInsensitive)==0)
                ...
                #if HAND == 0 || HAND == 1
                    if(QString::compare(fields.at(0),QString("init_vel_10_left"),Qt::CaseInsensitive)==0)
                ...
                #else
                    if(ui->checkBox_QbSoftHand_left->isChecked() && !(ui->checkBox_EG_left->isChecked())){
                        if(QString::compare(fields.at(0),QString("init_vel_9_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_init_vel_9_left->setText(fields.at(1));
                    }
                #endif
                if(QString::compare(fields.at(0),QString("final_vel_1_right"),Qt::CaseInsensitive)==0)
                ...
                #if HAND == 0 || HAND == 1
                  if(QString::compare(fields.at(0),QString("final_vel_10_right"),Qt::CaseInsensitive)==0)
                ...
                #else
                    if(ui->checkBox_QbSoftHand_right->isChecked() && !(ui->checkBox_EG_right->isChecked())){
                        if(QString::compare(fields.at(0),QString("final_vel_9_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_final_vel_9_right->setText(fields.at(1));
                    }
                #endif
                if(QString::compare(fields.at(0),QString("final_vel_1_left"),Qt::CaseInsensitive)==0)
                ...
                #if HAND == 0 || HAND == 1
                  if(QString::compare(fields.at(0),QString("final_vel_10_left"),Qt::CaseInsensitive)==0)
                ...
                #else
                    if(ui->checkBox_QbSoftHand_left->isChecked() && !(ui->checkBox_EG_left->isChecked())){
                        if(QString::compare(fields.at(0),QString("final_vel_9_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_final_vel_9_left->setText(fields.at(1));
                    }
                #endif
                if(QString::compare(fields.at(0),QString("init_acc_1_right"),Qt::CaseInsensitive)==0)
                ...
                #if HAND == 0 || HAND == 1
                  if(QString::compare(fields.at(0),QString("init_acc_10_right"),Qt::CaseInsensitive)==0)
                ...
                #else
                    if(ui->checkBox_QbSoftHand_right->isChecked() && !(ui->checkBox_EG_right->isChecked())){
                        if(QString::compare(fields.at(0),QString("init_acc_9_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_init_acc_9_right->setText(fields.at(1));
                    }
                #endif
                if(QString::compare(fields.at(0),QString("init_acc_1_left"),Qt::CaseInsensitive)==0)
                ...
                #if HAND == 0 || HAND == 1
                  if(QString::compare(fields.at(0),QString("init_acc_10_left"),Qt::CaseInsensitive)==0)
                ...
                #else
                    if(ui->checkBox_QbSoftHand_left->isChecked() && !(ui->checkBox_EG_left->isChecked())){
                        if(QString::compare(fields.at(0),QString("init_acc_9_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_init_acc_9_left->setText(fields.at(1));
                    }
                #endif
                if(QString::compare(fields.at(0),QString("final_acc_1_right"),Qt::CaseInsensitive)==0)
                ...
                #if HAND == 0 || HAND == 1
                  if(QString::compare(fields.at(0),QString("final_acc_10_right"),Qt::CaseInsensitive)==0)
                ...
                #else
                    if(ui->checkBox_QbSoftHand_right->isChecked() && !(ui->checkBox_EG_right->isChecked())){
                        if(QString::compare(fields.at(0),QString("final_acc_9_right"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_final_acc_9_right->setText(fields.at(1));
                    }
                #endif
                if(QString::compare(fields.at(0),QString("final_acc_1_left"),Qt::CaseInsensitive)==0)
                ...
                #if HAND == 0 || HAND == 1
                  if(QString::compare(fields.at(0),QString("final_acc_10_left"),Qt::CaseInsensitive)==0)
                ...
                #else
                    if(ui->checkBox_QbSoftHand_right->isChecked() && !(ui->checkBox_EG_right->isChecked())){
                        if(QString::compare(fields.at(0),QString("final_acc_9_left"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_final_acc_9_left->setText(fields.at(1));
                    }
                #endif
                if(QString::compare(fields.at(0),QString("Retreat_Final_Values_right"),Qt::CaseInsensitive)==0){
                    if(QString::compare(fields.at(1),QString("false\n"),Qt::CaseInsensitive)==0)
                        ui->Retreat_Final_Values_right_2->setChecked(false);
                    else
                        ui->Retreat_Final_Values_right_2->setChecked(true);
                }
                else if(QString::compare(fields.at(0),QString("Retreat_Final_Values_left"),Qt::CaseInsensitive)==0){
                    if(QString::compare(fields.at(1),QString("false\n"),Qt::CaseInsensitive)==0)
                        ui->Retreat_Final_Values_left->setChecked(false);
                    else
                        ui->Retreat_Final_Values_left->setChecked(true);
                }
                if(QString::compare(fields.at(0),QString("tar_xx_1_right"),Qt::CaseInsensitive)==0)
                ...
                else if(QString::compare(fields.at(0),QString("grasp_offset_right"), Qt::CaseInsensitive) == 0)
                    ui->lineEdit_grasp_offset_right->setText(fields.at(1));
                ...
                else if(QString::compare(fields.at(0),QString("grasp_offset_left"), Qt::CaseInsensitive) == 0)
                    ui->lineEdit_grasp_offset_left->setText(fields.at(1));
                    ...
                    if(QString::compare(fields.at(0),QString("final_hand_2_right"),Qt::CaseInsensitive)==0)
                    ui->lineEdit_final_hand_2_right->setText(fields.at(1));
                }
                #if HAND == 0 || HAND == 1
                    if(QString::compare(fields.at(0),QString("final_hand_3_right"),Qt::CaseInsensitive)==0)
                ...
                #endif
                if(QString::compare(fields.at(0),QString("final_hand_1_left"),Qt::CaseInsensitive)==0)
                    ui->lineEdit_final_hand_1_left->setText(fields.at(1));
                if(ui->checkBox_QbSoftHand_left->isChecked() || !ui->checkBox_EG_left->isChecked()){
                    if(QString::compare(fields.at(0),QString("final_hand_2_left"),Qt::CaseInsensitive)==0)
                    ui->lineEdit_final_hand_2_left->setText(fields.at(1));
                }
                #if HAND == 0 || HAND == 1
                    if(QString::compare(fields.at(0),QString("final_hand_3_left"),Qt::CaseInsensitive)==0)
                ...
                #endif
                if(QString::compare(fields.at(0),QString("sel_final_right"),Qt::CaseInsensitive)==0){
                    if(QString::compare(fields.at(1),QString("false\n"),Qt::CaseInsensitive)==0)
                ...
                #if HAND != 0 && HAND != 1
                    if(ui->checkBox_EG_right->isChecked() || ui->checkBox_EG_left->isChecked()){
                        if(QString::compare(fields.at(0),QString("max_velocity_gripper"),Qt::CaseInsensitive)==0)
                        ...
                        if(QString::compare(fields.at(0),QString("max_velocity_hand"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_w_max_SoftHand->setText(fields.at(1));
                        else if(QString::compare(fields.at(0),QString("max_alpha_hand"),Qt::CaseInsensitive)==0)
                            ui->lineEdit_alpha_max_SoftHand->setText(fields.at(1));
                    }
                #endif
                if(QString::compare(fields.at(0),QString("tar_av"),Qt::CaseInsensitive)==0){
                    if(QString::compare(fields.at(1),QString("false\n"),Qt::CaseInsensitive)==0)
                ...
                }else if(QString::compare(fields.at(0),QString("set_Electric_Gripper_right"),Qt::CaseInsensitive)==0){
                    if(QString::compare(fields.at(1),QString("false\n"),Qt::CaseInsensitive)==0)
                        ui->checkBox_EG_right->setChecked(false);
                    else
                        ui->checkBox_EG_right->setChecked(true);
                }else if(QString::compare(fields.at(0),QString("set_QbSoftHand_right"),Qt::CaseInsensitive)==0){
                    if(QString::compare(fields.at(1),QString("false\n"),Qt::CaseInsensitive)==0)
                        ui->checkBox_QbSoftHand_right->setChecked(false);
                    else
                        ui->checkBox_QbSoftHand_right->setChecked(true);
                }else if(QString::compare(fields.at(0),QString("set_Electric_Gripper_left"),Qt::CaseInsensitive)==0){
                    if(QString::compare(fields.at(1),QString("false\n"),Qt::CaseInsensitive)==0)
                        ui->checkBox_EG_left->setChecked(false);
                    else
                        ui->checkBox_EG_left->setChecked(true);
                }else if(QString::compare(fields.at(0),QString("set_QbSoftHand_left"),Qt::CaseInsensitive)==0){
                    if(QString::compare(fields.at(1),QString("false\n"),Qt::CaseInsensitive)==0)
                        ui->checkBox_QbSoftHand_left->setChecked(false);
                    else
                        ui->checkBox_QbSoftHand_left->setChecked(true);
...
int TolDialogHUMPDual::getMaxIterBounce()
{
...
#if HAND != 0 && HAND != 1
    double TolDialogHUMPDual::getGraspOffset_right(){
        return ui->lineEdit_grasp_offset_right->text().toDouble();
    }

    double TolDialogHUMPDual::getGraspOffset_left(){
        return ui->lineEdit_grasp_offset_left->text().toDouble();
    }

    void TolDialogHUMPDual::checkEGHand_right(int state){
        if(state == 0){
            ui->tab_fingers_EG_right->setEnabled(false);
            ui->checkBox_QbSoftHand_right->setEnabled(true);
        }else {
            ui->checkBox_QbSoftHand_right->setEnabled(false);
            ui->tab_fingers_EG_right->setEnabled(true);
            ui->tab_fingers_Qb_right->setEnabled(false);
            adaptationRightElectricGripper();
        }
    ...
    void TolDialogHUMPDual::checkEGHand_left(int state){
        if(state == 0){
            ui->tab_fingers_EG_left->setEnabled(false);
            ui->checkBox_QbSoftHand_left->setEnabled(true);
        }else {
            ui->checkBox_QbSoftHand_left->setEnabled(false);
            ui->tab_fingers_EG_left->setEnabled(true);
            ui->tab_fingers_Qb_left->setEnabled(false);
            adaptationLeftElectricGripper();
        }
    ...
    void TolDialogHUMPDual::checkQbHand_right(int state){
        if(state == 0){
            ui->tab_fingers_Qb_right->setEnabled(false);
            ui->checkBox_EG_right->setEnabled(true);
        }else {
            ui->checkBox_EG_right->setEnabled(false);
            ui->tab_fingers_EG_right->setEnabled(false);
            ui->tab_fingers_Qb_right->setEnabled(true);
            adaptationRightQbSoftHand();
        }
    ...
    void TolDialogHUMPDual::checkQbHand_left(int state){
        if(state == 0){
            ui->tab_fingers_Qb_left->setEnabled(false);
            ui->checkBox_EG_left->setEnabled(true);
        }else {
            ui->checkBox_EG_left->setEnabled(false);
            ui->tab_fingers_EG_left->setEnabled(false);
            ui->tab_fingers_Qb_left->setEnabled(true);
            adaptationLeftQbSoftHand();
        }
