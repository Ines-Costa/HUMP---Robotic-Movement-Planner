...
public Q_SLOTS:
    ...
    /**
     * @brief This method gets the grasp offset
     * @return
     */
     ...
     * @param state
     */
    void checkEGHand(int state);

    /**
     * @brief checkQbHand
     * @param state
     */
    void checkQbHand(int state);
...
public:
    ...
    /**
     * @brief This method gets the maximum angular velocity allowed for each gripper joint [deg/sec]
     * @return
     */
    double getWMaxSoftHand();

    /**
     * @brief This method gets the maximum angular acceleration allowed for each gripper joint [deg/sec²]
     * @return
     */
    double getAlphaMaxSoftHand();

    /**
     * @brief This method gets the maximum angula velocity allowed for each gripper joint [deg/sec]
     * @param w
     */
    ...
    /**
     * @brief getRetreatFinalValues_Info
     * @return
     */
    bool getRetreatFinalValues_Info();
...
private:
    ...
    // Hand
    int Hand; /**< hand chose by the operator*/
    ...
    void adaptationElectricGripper();
      ...
      /**
       * @brief adaptationQbSoftHand
       */
      void adaptationQbSoftHand();
};
