...
public:
     ...
     */
    Humanoid(string name, pos ppos, orient oor, dim ssize, arm aspecs_right, arm aspecs_left , int hand_code_right, int hand_code_left);
...
#else
    /**
     * @brief This method sets the specifications of the right arm
     * @param specs
     */
    void setRightArm(arm& specs);

    /**
     * @brief This method sets the specifications of the left arm
     * @param specs
     */
    void setLeftArm(arm& specs);
#endif
    ...
    /**
     * @brief This method sets the specifications of the QbSoftHand
     * @param specs_right
     */
    void setRightQbSoftHand(qbsofthand& specs);

    /**
     * @brief This method sets the specifications of the QbSoftHand
     * @param specs_left
     */
    void setLeftQbSoftHand(qbsofthand& specs_left);
#endif
    ...
    /**
     * @brief This method gets the right hand of the humanoid
     * @return
     */
    int getHandRight();

    /**
     * @brief This method gets the left hand of the humanoid
     * @return
     */
    int getHandLeft();
...
#else
    /**
     * @brief This method gets the right arm specifications of the humanoid
     * @return
     */
    arm getRightArm();

    /**
     * @brief This method gets the left arm specifications of the humanoid
     * @return
     */
    arm getLeftArm();
#endif
    ...
    /**
     * @brief This method sets the r parameters of the hand of the humanoid
     * @param rk
     */
    void setRK(vector<int>& rk);
#endif
...
private:
...
#else
     arm m_arm_right_specs; /**< specifications of the right arm */
     arm m_arm_left_specs; /**< specifications of the left arm */
#endif
    ...
    vector<int> rk; /**< r parameters of the Eletric Gripper*/
    // **** **************** **** //
    // **** QbSoftHand **** //
    qbsofthand m_qbSoftHand_specs_right; /**< specifications of the right hand >**/
    qbsofthand m_qbSoftHand_specs_left;  /**< specifications of the left hand >**/
    // **** ********** **** //
#endif
