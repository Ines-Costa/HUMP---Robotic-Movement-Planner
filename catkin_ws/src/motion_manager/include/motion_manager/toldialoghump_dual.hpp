...
#if HAND != 0 && HAND != 1
    /**
     * @brief checkEGHand_right
     * @param value
     */
    void checkEGHand_right(int value);

    /**
     * @brief checkEGHand_left
     * @param value
     */
    void checkEGHand_left(int value);

    /**
     * @brief checkQbHand_right
     * @param value
     */
    void checkQbHand_right(int value);

    /**
     * @brief checkQbHand_left
     * @param value
     */
    void checkQbHand_left(int value);
#endif
...
public:
     ...
     * @param typeLeftHand
     */
    void setTypeHands(int typeRightHand, int typeLeftHand);
    ...
    /**
     * @brief getWMaxSoftHand
     * @return
     */
    double getWMaxSoftHand();

    /**
     * @brief getAlphaMaxSoftHand
     * @return
     */
    double getAlphaMaxSoftHand();

    /**
     * @brief setWMaxSoftHand
     * @param w
     */
    void setWMaxSoftHand(double w);
#endif
    ...
    /**
     * @brief getRetreatFinalValuesRight_Info
     * @return
     */
    bool getRetreatFinalValuesRight_Info();

    /**
     * @brief getRetreatFinalValuesRight_Info
     * @return
     */
    bool getRetreatFinalValuesLeft_Info();
...
#if HAND != 0 && HAND != 1
    /**
     * @brief getGraspOffset_right
     * @return
     */
    double getGraspOffset_right();

    /**
     * @brief getGraspOffset_left
     * @return
     */
    double getGraspOffset_left();
#endif
...
private:
    ...
    #if HAND != 0 && HAND != 1
        /**
         * @brief adaptationRightElectricGripper
         */
        void adaptationRightElectricGripper();

        /**
         * @brief adaptationLeftElectricGripper
         */
        void adaptationLeftElectricGripper();

        /**
         * @brief adaptationRightQbSoftHand
         */
        void adaptationRightQbSoftHand();

        /**
         * @brief adaptationLeftQbSoftHand
         */
        void adaptationLeftQbSoftHand();
    #endif
};
