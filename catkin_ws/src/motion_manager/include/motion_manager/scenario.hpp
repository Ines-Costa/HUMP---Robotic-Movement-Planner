...
public:
    ...
    /**
     * @brief This method insert a target in the vector of poses at the position pos
     * @param pos
     * @param tg
     */
    void setTarget(int pos, targetPtr tg);
    ...
    /**
     * @brief This method get the list of the targets in the scenario
     * @param pts
     * @return
     */
    bool getTargets(vector<targetPtr>& tgs);
     ...
     * @param pose_ptr
     */
    void addTarget(targetPtr target_ptr);
     ...
     * @return
     */
    targetPtr getTarget(string pose_name);
...
private:
    ...
    vector<targetPtr> targets_list; /**< the targets in the scenario */
