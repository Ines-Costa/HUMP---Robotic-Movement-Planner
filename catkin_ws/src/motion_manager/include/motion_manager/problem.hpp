...
public:
     ...
     * It gets the code of the right hand used
     * @return
     */
     ...
     * It gets the code of the left hand used
     * @return
     */
    int getHandCodeLeft();
    ...
    /**
     * @brief setGraspOffset
     * It sets the the grasp offset
     * @return
     */
    void setGraspOffset(double value);

    /**
     * @brief setRightGraspOffset
     * @param value
     */
    void setRightGraspOffset(double value);

    /**
     * @brief setLeftGraspOffset
     * @param value
     */
    void setLeftGraspOffset(double value);
    /**
     * @brief getGraspOffset
     * It gets the the grasp offset
     * @return
     */
    double getGraspOffset();
...
private:
   ...
   /**
    ...
    double grasp_offset, right_grasp_offset, left_grasp_offset;
     ...
     * @param hand_code=1 for barret hand; hand_code=2 for Electric Gripper; hand_code=3 for QbSoftHand.
     * @param arm_code
     * @return
     */
    bool finalPostureFingers(int hand_id, int hand_code, int arm_code);

    /**
     * @brief This method computes the inverse kinematics of the hand.
     * @param d_obj: diameter of the object
     * @param sols: solution
     * @param hand_id: hand_used in the problem
     * @param hand_code: type of hand used in the problem
     * @param arm_code: which arm used (right, left or both)
     * @return
     */
    bool invKinHand(double d_obj,std::vector<double>& sols, int hand_id, int hand_code, int arm_code);

    #if HAND != 0 || HAND != 1
        /**
         * @brief This method computes the pose for the hand for a given size of the object.
         * @param d: diameter of the object
         * @param prec: indicates if its a precise or full grasp
         * @param hand_angles: angules for the joints of the hand based on the size of the object
         * @param hand: hand used
         * @return
         */
        std::vector<double> handPose(double *d, bool prec, std::vector<double>& hand_angles, qbsofthand hand);
        
        /**
         * @brief This method searchs the closest pose in the array for a certain d.
         * @param value: diameter of the object
         * @param prec: indicates if its a precise or full grasp
         * @param hand: hand used
         * @return
         */
        double findClosest(double value, qbsofthand hand);
    #endif
