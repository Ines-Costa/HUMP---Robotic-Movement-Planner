...
/* Hands */
// Hands = false, if the hands used in the problem for the two arms are the same.
// Hands = true, if the hands used in the problem are diferent for each arm
...
public:
    ...
    // The same hand is used for both arms (HANDS = false)
    ...
    //Diferent hands are used for each arm (HANDS = true)
    /* Right Hand */
    static unsigned hand_fingers_right;     /**< number of fingers in the right hand */
    static unsigned joints_hand_right;      /**< number of joints in the right hand */
    static unsigned n_phalange_right;       /**< number of phalanges in the right hand */

    /* Left Hand */
    static unsigned hand_fingers_left;      /**< number of fingers in the left hand */
    static unsigned joints_hand_left;       /**< number of joints in the left hand */
    static unsigned n_phalange_left;        /**< number of phalanges in the left hand */
    //--------------------------------------------------
   ...
   /**
    ...
    /**
     * @brief getRightQbSoftHand
     * @return
     */
    QbSoftHand getRightQbSoftHand();

    /**
     * @brief getLeftQbSoftHand
     * @return
     */
    QbSoftHand getLeftQbSoftHand();

    /**
     * @brief setsetRightQbSoftHand
     * @param qbhand_right
     */
    void setRightQbSoftHand(QbSoftHand &qbhand_right);

    /**
     * @brief setsetLeftQbSoftHand
     * @param qbhand_left
     */
    void setLeftQbSoftHand(QbSoftHand &qbhand_left);
...
private:
    ...
    QbSoftHand qbhand_right; /**< parameters of the right QbSoftHand>*/
    QbSoftHand qbhand_left; /**< parameters of the left QbSoftHand>*/
    QbSoftHand hand_problem;
     ...
     * @param mod
     */
    void directTrajectoryNoBound(int steps,std::vector<double>& initPosture, std::vector<double>& finalPosture, MatrixXd &Traj, int mod);
     ...
     * @param hand_code
     */
    void writeArmLimits(std::ofstream& stream, std::vector<double>& minArmLimits, std::vector<double>& maxArmLimits, bool final, int hand_code);
    ...
    void writeDualArmLimits(std::ofstream& stream, std::vector<double>& minRightArmLimits, std::vector<double>& maxRightArmLimits,
                            std::vector<double>& minLeftArmLimits, std::vector<double>& maxLeftArmLimits, bool final, int hand_code_right, int hand_code_left);
    ...
    /**
     * @brief writeQbSoftHandParams
     * This method writes down the parameter of the QbSofthand
     * @param qbhand
     * @param stream
     * @param final
     * @param arm_code
     */
    void writeQbSoftHandParams(QbSoftHand& qbhand, std::ofstream& stream, bool final, int arm_code);
    
    /**
     * @brief writeDualQbSoftHandParams
     * This method writes down the parameters of the QbSoftHand
     * @param qbhand
     * @param stream
     * @param right
     */
    void writeDualQbSoftHandParams(QbSoftHand& qbhand, std::ofstream& stream, bool right);

    /**
     * @brief This method writes down the declaration of the parameters of the QbSofthand
     * @param stream
     * @param final
     * @param arm_code
     */
    void writeQbSoftHandParamsMod(std::ofstream& stream, bool final, int atrm_code);
    
    /**
     * @brief writeDualQbSoftHandParamsMod (This method writes down the declaration of the parameters of the QbSofthand)
     * @param stream
     * @param right
     */
    void writeDualQbSoftHandParamsMod(std::ofstream& stream, bool right);

    /**
     * @brief This method writes down the direct kinematics of the QbSofthand
     * @param stream
     * @param tolsHand
     * @param final
     * @param place
     * @param arm_code
     */
    void writeQbSoftHandDirKin(ofstream &stream, MatrixXd &tolsHand, bool final, bool place, int arm_code);

    /**
     * @brief writeDualQbSoftHandDirKin
     * @param stream
     * @param tolsHand
     * @param final
     * @param place_right
     ...
     * @param arm_code
     */
    void writeDualQbSoftHandDirKin(ofstream &stream, MatrixXd &tolsHand, bool final, bool place_right, bool place_left, int arm_code);
     ...
     * @param arm_code
     */
    void writeHumanHandParams(HumanHand& hhand, std::ofstream& stream, int k, int arm_code);
     ...
     * @param arm_code
     */
    void writeHumanHandParamsMod(std::ofstream& stream, int arm_code);
     ...
     * @param arm_code
     */
    void writeBarrettHandDirKin(std::ofstream& stream, MatrixXd& tolsHand, bool final, bool transport, int arm_code);
    ...
    /**
     * @brief writeElectricGripperHandParams
     * Thi method writes down the parameters of the Electric Gripper
     * @param egripper
     * @param stream
     */
    ...
    /**
     * @brief writeDualElectricGripperParams
     * @param egripper
     * @param stream
     * @param right
     */
    void writeDualElectricGripperParams(ElectricGripper& egripper, std::ofstream& stream, bool right);

    /**
     * @brief This method writes down the declaration of the parameters of the Electric Gripper
     * @param stream
     */
    void writeElectricGripperParamsMod(std::ofstream& stream);

    /**
     * @brief writeDualElectricGripperParamsMod
     * @param stream
     * @param right
     */
    void writeDualElectricGripperParamsMod(std::ofstream& stream, bool right);

    /**
     * @brief This method writes down the direct kinematics of the Electric Gripper
     * @param stream
     * @param tolsHand
     * @param final
     * @param transport
     * @param arm_code
     */
    void writeElectricGripperDirKin(std::ofstream& stream, MatrixXd& tolsHand, bool final, bool transport, int arm_code);

    /**
     * @brief writeDualElectricGripperDirKin
     * @param stream
     * @param tolsHand
     * @param final
     * @param place_right
     ...
     * @param right
     */
    void writeDualElectricGripperDirKin(std::ofstream& stream, MatrixXd& tolsHand, bool final, bool place_right, bool place_left, bool right);
     ...
     * @param n_obstacles
     */
    void writeInfoObjectsMod(ofstream &stream,bool vec, int n_obstacles);
     ...
     * @param hand_code
     */
    void writeArmDirKin(ofstream &stream, Matrix4d &matWorldToArm, Matrix4d &matHand, std::vector<double>& tolsArm, bool final, int hand_code);
     ...
     * @return
     */
    bool singleArmFinalPosture(int mov_type, int pre_post, hump_params& params, std::vector<double> initPosture, std::vector<double>& finalPosture, std::vector<double> &zL, std::vector<double> &zU, std::vector<double> &lambda, int &iterations, double &time, double &obj, double &overall_error, std::vector<double> &obj_values, std::vector<double> &dual_inf_values, std::vector<double> &constr_viol_values, std::vector<double> &error_values, std::vector<double> &der_error_values,bool approach, bool retreat);
     ...
     * @return
     */
    int getDualSteps(std::vector<double> &maxLimits, std::vector<double> &minLimits, std::vector<double> &initPosture, std::vector<double> &finalPosture, int hand_code_right, int hand_code_left);
     ...
     * @return
     */
    void model_spheres_obs(ofstream &stream_dat,ofstream &stream_model,std::vector<objectPtr>& obstacles, std::vector<int>& n_spheres);

    /**
     * @brief model_spheres_target
     * @param stream_dat
     * @param stream_model
     * @param obj
     */
    int model_spheres_target(ofstream &stream_dat, ofstream &stream_model, objectPtr obj);
    ...
    /**
     * @brief getDualHandPos
     * @param arm
     * @param posture
     * @param pos
     */
    void getDualHandPos(int arm,vector<double> &posture,vector<double> &pos);
